...
$startTime = date("YmdHi",strtotime("-1 day"));
$endTime = date("YmdHi");


//패션플러스
getCancelApplyOrderList('fashionplus',$startTime,$endTime);
getDeliveryCancelApplyOrderList('fashionplus',$startTime,$endTime);
