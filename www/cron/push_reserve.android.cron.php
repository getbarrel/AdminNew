...
//보내지 않고 타입이 푸시인것만.
$sql = "SELECT * FROM mobile_push_reserve WHERE b_send = '0' AND reserve_type = 'P' AND reserve_push_os='a' and reserve_time <= '".date("Y-m-d H:i:s")."' order by sequence asc limit 0, 1";
$db->query($sql);
$db->fetch();
