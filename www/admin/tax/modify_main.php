<?
	...
	getPopbillStatusUdate();//세금계산서 상태 업데이트 구문
...
*/
	...
	<table cellpadding=0 cellspacing=0 border=0 width='100%' style='margin-bottom:20px;'>
		<tr>
			<td align='left' colspan=6 > <img src='../images/".$admininfo[language]."/step_modify01.gif' align='absmiddle'></td>
		</tr>
	</table>
";
...
$Contents .= "
	...
	$where = " where status = '1' and send_status ='4' and publish_type in ('1','3')";
		...
		for ($i = 0; $i < $db->total; $i++)
		{
			...
			$Contents .= "
			  <tr height='30' align='center' bgcolor='#FFFFFF'>
				...
				<td class='list_box_td list_bg_gray'><a href='./".$send_url."?idx=".$db->dt[idx]."'><img src='../images/".$admininfo[language]."/btn_quick_view.gif'  style='cursor:pointer' align='absmiddle'></a><br><a href='./modify_select.php?idx=".$db->dt[idx]."&publish_type=".$db->dt[publish_type]."&tax_type=".$db->dt[tax_type]."'><img src='../images/".$admininfo[language]."/btn_modify_public.gif'  style='cursor:pointer' align='absmiddle'></a></td>
			  </tr>
			";
...
$Contents .= "<tr height='80' align='center' bgcolor='#FFFFFF'>
	...
	$P->jquery_use = true;
	$P->Navigation = "세금계산서관리 > 수정발행 > 원본 전자(세금)계산서 선택";
	$P->title = "수정발행";
