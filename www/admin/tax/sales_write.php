...
//alert($('#sdate').attr('disabled'));
		if($('#sdate').attr('disabled') == 'disabled'){
...
";
			...
			<tr>
				<td class='tab' align='left'>
					<table id='tab_01' $tab01>
						<tr>
							<th class='box_01'></th>
							<td class='box_02' onclick=\"document.location.href='./sales_write.php?idx=$idx&tax_type=1&publish_type=$publish_type&mode=$mode'\">세금계산서</td>
							<th class='box_03'></th>
						</tr>
						</table>
						...
						<tr>
							<th class='box_01'></th>
							<td class='box_02' onclick=\"document.location.href='./sales_write.php?idx=$idx&tax_type=2&publish_type=$publish_type&mode=$mode'\" >계산서(면세)</td>
							<th class='box_03'></th>
						</tr>
					</table>
				</td>
				<td align='right'>
					".GetCertificateExpireDate($s_company_number)."
				</td>
			</tr>
		</table>
	</div>";
	...
	<form name='frm' id='frm' action='./sales_write_act.php' method='POST' target='PROC' enctype='multipart/form-data'><!--PROC-->
	...
	<input type='hidden' name='document_type' id='document_type' value='1'><!--문서형태 1:일반 2: 수정-->
";
	if($mode == 'modify' || $idx == ""){
	$Contents .= "
	...
	<tr height='35'>
		...
		<td colspan='2' align='center' class='RBLine'>
			<input type='text' class='tb' name='s_company_j' id='s_company_j' valtype='NUM' value='$s_company_j' maxlength='4' style='width:100%;IME-MODE:disabled;'>
		</td>
		...
		<td colspan='2' align='center' class='BLine'>
			<input type='text' class='tb' name='r_company_j' id='r_company_j' valtype='NUM' value='$r_company_j' maxlength='4' style='width:100%;IME-MODE:disabled;'>
		</td>
	...
	<tr height='35'>
		...
		<td colspan='13' align='left' class='RBLine'>
			...
			<select name='email_com' id='email_com' class='sb' align='absbottom' style='width:119px;'>
		...
		<td colspan='3' align='center' class='RBLine_T'>이메일</td>
		<td colspan='13' align='left' class='BLine'>
			<input type='text' class='tb' name='r_email1' id='r_email1' value='$r_email[0]' style='width:34%;'> @ <input type='text' class='tb'  name='r_email2' id='r_email2' value='$r_email[1]' style='width:33%;'>
			<select name='email_com2' id='email_com2' class='sb' align='absbottom' style='width:115px;'>
				<option value='&nbsp;'>직접입력</option>
				<option value='chol.com'>chol.com</option>
				<option value='dreamwiz.com'>dreamwiz.com</option>
				<option value='empal.com'>empal.com</option>
	...
	<tr height='35'>
		...
		$Contents .= "
		<td colspan='30' align='center' class='RBLine_T'><b>공급가액</b></td>
		";
		}
		$Contents .= "
	</tr>
	<tr height='35'>
		<td colspan='4' class='RBLine' style='padding:0px 4px 0px 2px;' align='center'><input type='text' name='signdate' id='sdate' ".($mode == 'modify' ? "value='$signdate'" : "value='".date('Y-m-d')."'")." class='tb_readonlycogoodscogoods' style='width:100px; text-align:center' IconYN='0' ></td>
		";
		if($tax_type == '1'){
			if($tax_price == 0){
				$tax_price = $supply_price * 0.01;
			}
		$Contents .= "
		...
		$Contents .= "
		<td colspan='30' class='RBLine'><input type='text' class='tb_readonly' name='supply_price' id='supply_price' maxlength='18' style='width:100%;IME-MODE:disabled;text-align:right;' value='$supply_price' readonly></td>
	...
	<tr height='35'>
		...
		<td colspan='29' class='RBLine'><input type='text' class='tb' name='marking' id='marking' maxlength='150' style='width:100%;' value='$marking'></td>
	...
	<tr height='35'>
		...
		$Contents .= "
		<td colspan='9' align='center' class='RBLine_T'><b>공급가액</b></td>
...
if($idx != "")
{
	...
	for ($i = 0; $i < $db->total; $i++)
	{
		...
		<tr height='35' id='Detail1'>
			...
			$Contents .= "
			<td colspan='9' align='center' class='RBLine'><input type='text' class='tb' name='p_price[$k]' id='p_price[$k]' maxlength='18' style='width:95%;IME-MODE:disabled;text-align:right;' valtype='NUM' value='$p_price' onkeyup='calculator_ing();num_chk(this);'></td>
			...
			<td colspan='1' align='center' class='BLine_T'>
				<!--img src='./img/close.gif' id='DelDetail' class='Buttons' onclick='del_row(1)'-->
				<img src='../images/".$admininfo[language]."/btn_del.gif' onclick='del_row(1)' id='DelDetail' style='cursor:pointer' align='absmiddle'>
			</td>
		</tr>
		";
	}
...
else
{
	...
	$Contents .= "
		<tr height='35' id='Detail".$k."'>
			...
			$Contents .= "
			<td colspan='9' align='center' class='RBLine'><input type='text' class='tb' name='p_price[$k]' id='p_price[$k]' maxlength='18' style='width:95%;IME-MODE:disabled;text-align:right;' valtype='NUM' value='' onkeyup='calculator_ing();num_chk(this);'></td>
			...
			<td colspan='1' align='center' class='BLine_T'>
				<!--img src='./img/close.gif' id='DelDetail' class='Buttons' onclick='del_row(1)'-->
				<img src='../images/".$admininfo[language]."/btn_del.gif' onclick='del_row(".$k.")' id='DelDetail' style='cursor:pointer' align='absmiddle'>
			</td>
		</tr>
	";
	}
	...
	<tr height='35'>
		...
		<td colspan='9' rowspan='2' align='center' class='NoLine'>
			<table border='0' cellpadding='0' cellspacing='0' width='100%' style='table-layout:fixed;'>
				...
				<tr>
					<td height='23'>
						<input type='radio' name='claim_kind' id='claim_kind1' value='1' ".($claim_kind == '1' ? "checked" : "")." style='vertical-align:middle;'><label for='claim_kind1'> <span style='vertical-align:middle;'>영수</span></label>
						<input type='radio' name='claim_kind' id='claim_kind2' value='2' ".($claim_kind == '2' || $claim_kind == '' ? "checked" : "")." style='vertical-align:middle;'><label for='claim_kind2'> <span style='vertical-align:middle;'>청구</span></label>
					</td>
				</tr>
			</table>
		</td>
...
$Contents .= "
	...
	<tr height='35'>
		<td colspan='4' align='right' class='BLine_T'>일련번호 :</td>
		<td colspan='8' class='BLine' align='right' style='padding:0px 8px 0px 6px;'>$numbering</td>
	</tr>
	<tr height='35'>
		<td colspan='1' rowspan='6' align='center' class='RBLine_T' style='line-height:22px;'><b>공<br>급<br>자</b></td>
		<td colspan='3' align='center' class='RBLine_T'>등록번호</td>
	...
	<tr height='35'>
		...
		if($tax_type == '1'){
		$Contents .= "
		<td colspan='16' class='RBLine'>$supply_price</td>
		<td colspan='14' class='BLine'>$tax_price</td>
		";
		}else{
		$Contents .= "
		<td colspan='30' class='RBLine'>$supply_price</td>
		";
		}
		$Contents .= "
	</tr>
	...
	<tr height='35'>
		<td colspan='4' align='center' class='RBLine_T'><b>비고</b></td>
		<td colspan='29' class='RBLine'>$marking</td>
		<td colspan='1' class='BLine'></td>
	</tr>
...
";
	...
	for ($i = 0; $i < $db->total; $i++)
	{
		...
		<tr height='35' id='Detail1'>
			...
			<td colspan='3' align='center' class='RBLine'>$price</td>
			";
			if($tax_type == '1'){
			$Contents .= "
			<td colspan='5' align='center' class='RBLine'>$p_price</td>
			<td colspan='4' align='center' class='RBLine'>$tax</td>
			";
			}else{
			$Contents .= "
			<td colspan='9' align='center' class='RBLine'>$p_price</td>
			";
			}
			$Contents .= "
			<td colspan='6' align='center' class='RBLine'>$comment</td>
			<td colspan='1' align='center' class='BLine_T'>
...
$Contents .= "
	...
	<tr height='35'>
		<td colspan='9' align='right' class='RLine'>$total_price</td>
		<td colspan='4' align='right' class='RLine'>$cash</td>
		<td colspan='4' align='right' class='RLine'>$cheque</td>
		<td colspan='4' align='right' class='RLine'>$pro_note</td>
		<td colspan='4' align='right' class='RLine'>$outstanding</td>
	</tr>
</table>";
}
$Contents .= "
...
if($tax_type == 1)
{
	...
	<table width='100%' class='input_table_box' style='margin:10px 0 0 0'>
		<tr>
			<td class='input_box_title' rowspan='2' align='center' width='150'><img src='../image/title_head.gif'> 국세청전송방법</td>
...
<table width='100%' style='margin:10px 0 0 0;' cellpadding='0' cellspacing='0' class='input_table_box'>
	<tr>
		<td class='input_box_title' width='120' style='padding:0 0 0 10px'>문자발송정보</td>
		<td class='input_box_item'>
			<input type='checkbox' name='sms_chk' id='sms_chk' value='Y' $sms_checked> 문자발송여부
			<input type='text' class='textbox' name='hp1' id='hp1' style='width:50px' value='$sms_number[0]'> - <input type='text' class='textbox' name='hp2' id='hp2' style='width:50px' value='$sms_number[1]'> - <input class='textbox' type='text' name='hp3' id='hp3' style='width:50px' value='$sms_number[2]'>
		</td>
	</tr>
	<tr>
		<td class='input_box_title' style='padding:0 0 0 10px'>팩스발송정보</td>
		<td class='input_box_item'>
...
$Contents .= "
	<tr>
		<td class='input_box_title' style='padding:0 0 0 10px'>첨부파일</td>
		...
		if($idx != "")
		{
			...
			for ($i = 0; $i < $db->total; $i++)
			{
				...
				$f_idx = $db->dt["idx"];
				$filename = $db->dt["file"];
				$Contents .= "<tr height='20' id='f_show".$f_idx."'><td><a href='./download_data.php?idx=".$f_idx."' target='PROC'>$filename</a></td><td>
					<!--img src='/admin/tax/img/close.gif' onclick='del_data(".$f_idx.")'-->
					<img src='../images/".$admininfo[language]."/btn_del.gif' onclick='del_data(".$f_idx.")' id='DelDetail' style='cursor:pointer' align='absmiddle'>
				</td></tr>";
			}
			$Contents .= "</table>";
		}
...
$Contents .= "
		<span class='file1' style='padding:10px 5px 10px 5px'>
			<input type='file' name='DataFile[]' class='textbox' id='DataFile[]' style='height:22px; border:1px solid #c5c5c5'> <!--img src='./img/add_.gif' align='absbottom' onclick='add_filearea()'--> </span><span class='file1'><img src='../images/".$admininfo[language]."/btn_add_ico.gif' id='add_btn' style='cursor:pointer' align='absmiddle' onclick='add_filearea()'></span><br>
		</td>
	</tr>
";
...
$Contents .= "
	<tr>
		<td class='input_box_title' style='padding:0 0 0 10px'>메모</td>
		<td class='input_box_item' height='140' style='padding:5px 0 0 5px'>
...
<table width='100%' style='margin-top:15px;'>
	...
	<tr>
		...
		$Contents .= "
		<td align='center'>
			<a href='javascript:frm_submit(0)'><img src='../images/".$admininfo[language]."/b_save.gif' align='absmiddle'></a>
		</td>
		<td align='right'>
			<a href='?idx=$idx&tax_type=$tax_type'><img src='../images/".$admininfo[language]."/btn_prevpage.gif' align='absmiddle'></a>
		</td>";
		}else{
		$Contents .= "
		<td align='center'>
		...
		<td align='right'>
			<!--a href='javascript:frm_submit(0)'><img src='../images/".$admininfo[language]."/bt_modify.gif' align='absmiddle'></a-->
			<a href='?idx=$idx&mode=modify&tax_type=$tax_type'><img src='../images/".$admininfo[language]."/bt_modify.gif' align='absmiddle'></a>
		</td>";
		}
		$Contents .= "
	</tr>
...
$Contents .= "
	...
	$P->jquery_use = true;
	$P->Navigation = "세금계산서관리 > 세금계산서 발행 > 매출작성";
	$P->title = "매출작성";
