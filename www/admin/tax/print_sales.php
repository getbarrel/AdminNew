...
$Contents .= "
<div id='stamp' style='position:absolute;background-image:url(\"./img/stamp_".$status.".png\");TOP:100px;LEFT:500px;'>
...
if($f_submit == "Y")
{
	/*if($status == "1")
	{
		$Contents .= "
			<table width='100%'>
				...
				<tr align='center'>
					<td><input type='button' value='승인취소' onclick='PROC.location.href=\"./proc.statusChange.php?idx=$idx&toStatus=6\"'></td>
				</tr>
			</table>
	...
	if($status == "4")
	{
		$Contents .= "
			<table width='100%'>
				...
				<tr align='center'>
					<td><input type='button' value='승인' onclick='PROC.location.href=\"./proc.statusChange.php?idx=$idx&toStatus=1\"'><!--<a href='/admin/tax/publish_ok.php?idx=$idx' target='PROC'><img src='/admin/tax/img/publish.gif'></a>--> <input type='button' value='승인거부' onclick='PROC.location.href=\"./proc.statusChange.php?idx=$idx&toStatus=5\"'></td>
				</tr>
			</table>
			<iframe name='PROC' width='0' height='0'></iframe>
		";
	...
	/*if($status == "5")
	{
		$Contents .= "
			<table width='100%'>
				<tr>
					<td height='20'>공급받는자로부터 승인거부상태입니다.</td>
				</tr>
				<tr align='center'>
					<td></td>
				</tr>
