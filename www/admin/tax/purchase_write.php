<?
	...
	if($idx == "")
	{
		...
		$r_item				= $db->dt[com_business_category];					// 업종
	...
	<table cellpadding=0 cellspacing=0 border=0 width='100%'>
		<tr >
			<td align='left' colspan=6 > ".GetTitleNavigation("매입작성(역발행)", "세금계산서발행 > 매입작성(역발행) ")."</td>
		</tr>
	</table>
...
";
			...
			<tr>	
				<td class='tab' align='left'>
					<table id='tab_01' $tab01>
						<tr>
							<th class='box_01'></th>
							<td class='box_02' onclick=\"document.location.href='$PHP_SELF?idx=$idx&tax_type=1&mode=$mode'\">세금계산서</td>
							<th class='box_03'></th>
						</tr>
						</table>
						...
						<tr>
							<th class='box_01'></th>
							<td class='box_02' onclick=\"document.location.href='$PHP_SELF?idx=$idx&tax_type=2&mode=$mode'\" >계산서</td>
							<th class='box_03'></th>
						</tr>
					</table>
				</td>
				...
				<td align='right'>
					".GetCertificateExpireDate($r_company_number)."
				</td>
			</tr>
		</table>
	</div>";
	...
	<input type='hidden' name='modi_type' id = 'modi_type' value='".$_GET[mode]."'>
	";
	if($mode == 'modify' || $idx == ""){
	$Contents .= "
	";
		if($mode == 'modify'){
		$Contents .= "
		<input type='hidden' name='status' id='status' value='0'><!-- 1.발행 2.임시저장 3.국세청전송-->	";
		}else{
		$Contents .= "
	...
	<tr height='35'>
		...
		<td colspan='8' class='BLine' align='right' style='padding:0px 8px 0px 7px;'><input type='text' class='tb' name='numbering' style='width:95%;IME-MODE:disabled;text-align:right;' valtype='NUM' maxlength='27' value='$numbering'></td>
	</tr>
	<tr height='35'>
	...
	<tr height='35'>
		...
		<td colspan='8' align='left' class='RBLine'>
			<textarea class='readonly' name='s_company_name' id='s_company_name' style='width:94%;height:26px;overflow:hidden;' Essential='1' maxlength='70'>$s_company_name</textarea>
		</td>
		...
		<td colspan='3' align='center' class='RBLine_T' style='line-height:16px;'>상호<br>(업체명)</td>
		<td colspan='8' align='left' class='RBLine'>
			<textarea class='tb_readonly' name='r_company_name' id='r_company_name' style='width:97%;height:26px;overflow:hidden;' Essential='1' readonly maxlength='70'>$r_company_name</textarea>
		</td>
		<td colspan='1' align='center' class='RBLine_T' style='line-height:16px;'>성<br>명</td>
	...
	<tr height='35'>
		...
		<td colspan='13' align='left' class='RBLine'>
			<textarea class='tb' name='s_address' id='s_address' style='width:98%;height:26px;overflow:hidden;' maxlength='150'>$s_address</textarea>
		</td>
		<td colspan='3' align='center' class='RBLine_T' style='line-height:16px;'>사업장<br>주소</td>
		<td colspan='13' align='left' class='BLine'>
			<textarea class='tb_readonly'  name='r_address' id='r_address' style='width:98%;height:26px;overflow:hidden;' readonly maxlength='150'>$r_address</textarea>
		</td>
	</tr>
	<tr height='35'>
	...
	<tr height='35'>
		<td colspan='4' class='RBLine' style='padding:0px 4px 0px 2px;' align='center'><input type='text' name='signdate' id='sdate' ".($mode == 'modify' ? "value='$signdate'" : "value='".date('Y-m-d')."'")." class='tb' style='width:80px;text-align:center' IconYN='0' ></td>
		";
		if($tax_type == '1'){
			if($tax_price == 0){
...
$Contents .= "
	...
	<tr height='35'>
		<td colspan='4' align='right' class='BLine_T'>일련번호 :</td>
		<td colspan='8' class='BLine' align='right' style='padding:0px 8px 0px 7px;'>$numbering</td>
	</tr>
	<tr height='35'>
		<td colspan='1' rowspan='6' align='center' class='RBLine_T' style='line-height:22px;'><b>공<br>급<br>자</b></td>
		<td colspan='3' align='center' class='RBLine_T'>등록번호</td>
...
$Contents .= "
	...
	$P->jquery_use = true;
	$P->Navigation = "세금계산서관리 > 세금계산서 발행 > 매입작성(역발행)";
	$P->title = "매입작성(역발행)";
