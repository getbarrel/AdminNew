...
$Contents .= "
	...
	if($publish_type == "total" || $publish_type == "")	{
		$where = " where status = '1' and send_status = '1' ";
	}else{
		$where = " where status = '1' and send_status = '1' and publish_type = '$publish_type'";
	}
...
$Contents .= "<tr height='80' align='center' bgcolor='#FFFFFF'>
	...
	<table width='100%' border='0' cellpadding='3' cellspacing='0' align='center' >
		<tr height=40>
			<td align='left' width='25%'><img src='../images/".$admininfo[language]."/btn_publish_IRS_all.gif'  style='cursor:pointer' align='absmiddle' id='pbl_all_btn'> <img src='../images/".$admininfo[language]."/btn_select_del.gif'  style='cursor:pointer' align='absmiddle' id='del_btn'></td>
