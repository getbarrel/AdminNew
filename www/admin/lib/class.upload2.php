    ...
    function process($server_path = null) {
        ...
        if ($this->processed) {
            ...
            if ($this->file_safe_name) { // formats the name
                $this->file_dst_name_body = strtr($this->file_dst_name_body, '힋탐큄탑타?횁횂횄횆횇횉횊횋횎횏횑횒횓횕횗횘횙횚횛횜횠횢횣횤횥횦횪찼창찾채책챌챔챕챗챘챙챠챤챦챰챵처척천철첩첫첬청체첵첼', 'SZszYAAAAAACEEEEIIIINOOOOOOUUUUYaaaaaaceeeeiiiinoooooouuuuyy');
