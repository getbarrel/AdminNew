...
if($act == "update"){
    ...
    echo("<script language='javascript' src='../js/message.js.php'></script><script>show_alert('게시판 템플릿 정보가 정상적으로 수정 되었습니다.');parent.document.location.href='./cscenter_response_templet.php';</script>");
}
...
if($act == "delete"){
    ...
    echo("<script language='javascript' src='../js/message.js.php'></script><script>show_alert('게시판 템플릿 정보가 정상적으로 삭제 되었습니다.');parent.document.location.href='./cscenter_response_templet.php';</script>");
}
