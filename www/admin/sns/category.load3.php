...
if($cid){
	...
	echo "<script type='text/javascript'>
		...
		if(top.document.forms['$form'].elements['c_cid2']) top.document.forms['$form'].elements['c_cid2'].value = '';
	</script>";
	exit;
}
...
if ($db->total){
        ...
        echo "<script type='text/javascript'>
			...
			if(top.document.forms['$form'].elements['cid2']) top.document.forms['$form'].elements['cid2'].value = '".$cid."';
			if(top.document.forms['$form'].elements['depth']) top.document.forms['$form'].elements['depth'].value = '".$depth."';
		</script>";
