...
(document.getElementById("SM114641" + "I")).src = "../image/arrow_blue.gif";
(document.getElementById("SM1146487" + "I")).src = "../image/arrow_blue.gif";
(document.getElementById("SM11464176" + "I")).src = "../image/arrow_blue.gif";
(document.getElementById("SM11464177" + "I")).src = "../image/arrow_blue.gif";
(document.getElementById("SM11464243" + "I")).src = "../image/arrow_blue.gif";
//(document.getElementById("SM11464332" + "I")).src = "../image/arrow_blue.gif";
...
SMToOpen11464 = parseInt(SMheightToOpen11464); 
	...
	{ 
		...
		(document.getElementById(SMsubID + "I")).src = "../image/arrow_blue1.gif";
	} 
} 
