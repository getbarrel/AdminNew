...
/** report icon */
var REPORT_ICON = "../resources/SiteReport_Report.gif";

/** Data Icon */
var DATA_ICON = "../resources/Common_Data.gif";


/** System Defined Buttons */
var ADD_BUTTON = "../resources/Common_Add.gif";
var DELETE_BUTTON = "../resources/Common_Delete.gif";
var PROPERTY_BUTTON = "../resources/Common_Property.gif";
var OK_BUTTON = "../resources/Common_Ok.gif";
var CANCEL_BUTTON = "../resources/Common_Cancel.gif";
var EDIT_BUTTON = "../resources/Common_Edit.gif";
var FIND_BUTTON = "../resources/Common_Find.gif";
var DOWNLOAD_EXCEL_BUTTON = "../resources/Common_Download_Excel.gif";
var HELP_BUTTON = "../resources/Common_Help.gif";
var NEXT_BUTTON = "../resources/Common_Next.gif";
var PREV_BUTTON = "../resources/Common_Prev.gif";
var CHANGENAME_BUTTON = "../resources/Common_ChangeName.gif";
var MERGE_FRAME_BUTTON = "../resources/Common_Merge_Frame.gif";
var DIVIDE_FRAME_BUTTON = "../resources/Common_Divide_Frame.gif";
var PRINT_BUTTON = "../resources/Common_Print.gif";
var SAVE_BUTTON = "../resources/Common_Save.gif";
var SAVEAS_BUTTON = "../resources/Common_SaveAs.gif";
var SMALLER_BUTTON = "../resources/Common_Smaller.gif";
var LARGER_BUTTON = "../resources/Common_Larger.gif";
var OPEN_BUTTON ="../resources/Common_Open.gif";
var EXECUTE_BUTTON = "../resources/Common_Ok.gif";
var CLOSE_BUTTON = "../resources/Common_Close.gif";

var ADD_BUTTONICON = "../resources/Common_Button_Add.gif";
var EDIT_BUTTONICON = "../resources/Common_Button_Edit.gif";
var MODIFY_BUTTONICON = "../resources/Common_Button_Modify.gif";
var DELETE_BUTTONICON = "../resources/Common_Button_Delete.gif";
var CANCEL_BUTTONICON = "../resources/Common_Button_Cancel.gif";
var VIEW_BUTTONICON = "../resources/Common_Button_View.gif";
var UP_BUTTONICON = "../resources/Common_Button_Up.gif";
var DOWN_BUTTONICON = "../resources/Common_Button_Down.gif";
var SAVE_BUTTONICON = "../resources/Common_Button_Save.gif";
var SELECT_BUTTONICON = "../resources/Common_Button_Select.gif";
var SEARCH_BUTTONICON = "../resources/Common_Button_Search.gif";
var OK_BUTTONICON = "../resources/Common_Button_OK.gif";
var INIT_BUTTONICON = "../resources/Common_Button_Init.gif";
var REGISTER_BUTTONICON = "../resources/Common_Button_Register.gif";
var SERVERSTART_BUTTONICON = "../resources/Common_Button_ServerStart.gif";
var SERVERSTOP_BUTTONICON = "../resources/Common_Button_ServerStop.gif";
var EXAMINE_BUTTONICON = "../resources/Common_Button_Examine.gif";
var NEXT_BUTTONICON = "../resources/Common_Button_Next.gif";
var PREV_BUTTONICON = "../resources/Common_Button_Prev.gif";



var DATA_LIST = "../resources/Common_List_Data.gif";
var DATASELECTED_LIST = "../resources/Common_List_DataSelected.gif";
var USER_LIST = "../resources/Common_List_User.gif";
var USERSELECTED_LIST = "../resources/Common_List_UserSelected.gif";
var MESSAGE_LIST = "../resources/Common_List_Message.gif";
var MESSAGESELECTED_LIST = "../resources/Common_List_MessageSelected.gif";
