...
$list = getInAddressInfoList($site_code);
...
$Contents01 = "
	<table width='100%' cellpadding=0 cellspacing=0 border='0' align='left'>
	  ...
	  <col width='*'>
	  <tr >
		<td align='left' colspan=6 > ".GetTitleNavigation("반품/교환지 관리", "제휴사연동 > 반품/교환지 관리")."</td>
	  </tr>
	  <tr>
	    <td align='left' colspan=4 style='padding:3px 0px;'> ".colorCirCleBox("#efefef","100%","<div style='padding:5px 5px 5px 10px;'><img src='../image/title_head.gif' align=absmiddle> <b class=blk>반품/교환지 추가/수정</b></div>")."</td>
	  </tr>
	  </table>
...
$Contents02 = "
	<div style='width:100%;'>".colorCirCleBox("#efefef","100%","<div style='padding:5px 5px 5px 10px;'><img src='../image/title_head.gif' align=absmiddle> <b class=blk>반품/교환지 목록</b></div>")."</div>";
...
if(!empty($list)){
	...
	$Contents02 .= "
		  <tr bgcolor=#ffffff height=50>
		    <td align=center colspan=9>등록된 반품/교환지 정보가 없습니다. </td>
		  </tr>";
}
$Contents02 .= "
...
<input name='act' type='hidden' value='inAddr_regist'>
";
...
//$help_text = getTransDiscription(md5($_SERVER["PHP_SELF"]),'D');
	...
	$help_text = HelpBox("반품/교환지 관리", $help_text);
