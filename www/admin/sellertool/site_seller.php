			...
			<table border=0 cellpadding=0 cellspacing=0>
				<tr>
					<td style='padding-right:5px;'>
						".getSellerToolSiteKeyInfo($si_ix , "" ,"selectbox" ," ")."
					</td>
				</tr>
			</table>
		</td>
		<td class='input_box_title'> <b>API 연동 방식</b></td>
		<td class='input_box_item'>
			<input type=radio name='api_type' id='api_type_1' value='1' ".CompareReturnValue("1",$db->dt[api_type],"checked")."><label for='api_type_1'>자체 API 사용</label>
	    	<input type=radio name='api_type' id='api_type_2' value='2' ".CompareReturnValue("2",$db->dt[api_type],"checked")."checked><label for='api_type_2'>대표 API 사용</label>
		</td>
	</tr>
...
$sql = "select si.site_div, si.site_name, site_code, ssi.*  from sellertool_site_info si , sellertool_site_seller_info ssi where si.si_ix = ssi.si_ix  order by vieworder asc ";
$db->query($sql);
/*
...
if($db->total){
	...
	$Contents02 .= "
		  <tr bgcolor=#ffffff height=30 align=center>
			...
			<td class='list_box_td'>".($db->dt[api_type] == "1" ?  "자체 API":"대표 API")."</td>
...
$Contents = "<form name='site_form' action='site_seller.act.php' method='post' onsubmit='return CheckValue(this)' target=act>
