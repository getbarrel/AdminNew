...
require_once $_SERVER['DOCUMENT_ROOT'] .'include/pear/Message/Message.php';
require_once $_SERVER['DOCUMENT_ROOT'] .'include/pear/Message/Hash/common.php';
require_once $_SERVER['DOCUMENT_ROOT'] .'include/pear/Message/Hash/SHA256.php';
