...
/*	Create Root node	*/
	var rootnode = new TreeNode(\"전시분류\", \"../resources/ServerMag_Etc_Root.gif\",\"../resources/ServerMag_Etc_Root.gif\");
	rootnode.action = \"setCategory('전시분류','000000000000000',-1,'', 1, 1)\";
	rootnode.expanded = true;
";


$db->query("SELECT * FROM ".TBL_SHOP_DISPLAY_DIV." where depth in(0,1) AND display_div=$display_div");
$total = $db->total;
...
.textbox_noneBorder {border:0;}
		...
		<tr>
			...
			<div id=TREE_BAR >
				...
				<tr>
					<td style='padding-left:10px;padding-top:5px;padding-bottom:3px;' valign=middle nowrap>
						<form name='category_order' method='get' action='display_div_order.php' target='calcufrm'>
			...
			<td valign=top width='100%' align='left' style=''>
				...
				<form name='thisCategoryform' method=\"post\"  action='display_div.save.php' target='calcufrm' style='display:inline;'>
				...
				<form name='subCategoryform' method=\"post\"  action='display_div.save.php' target='calcufrm' style='display:inline;'>
...
$Contents .= "
		...
		<iframe name='calcufrm' id='calcufrm' src='' width=700 height=200 style='display:none' ></iframe>";
