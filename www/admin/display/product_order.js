...
function setCategory(cname,cid,depth,pid,company_id,max){
	//alert(max);
	//document.frames['act'].location.href='?cid='+cid+'&depth='+depth+'&company_id='+company_id+'&max='+max+'&view=innerview';
	document.getElementById("act").src='?mode=search&cname='+cname+'&cid2='+cid+'&depth='+depth+'&company_id='+company_id+'&max='+max+'&view=innerview';
