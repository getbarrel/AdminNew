...
$Contents .= "					 
				...
				$Contents .= "
								<tr>
									...
									<td class='input_box_item' colspan=3>
										<select name='place_radius'   validation=true title='펜스반경'>
...
<script type='text/javascript' src='//apis.daum.net/maps/maps3.js?apikey=dcac4abff2e814775cd1061ee4d58814&libraries=services'></script>
...
//우편번호 검색
	...
	daum.maps.event.addListener(marker, 'dragend', function() {
		...
		$('#latitude').val(position.Ab);
		$('#longitude').val(position.zb);
	...
	function makerMap(latitude, longitude){
