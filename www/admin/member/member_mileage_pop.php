...
<div class='cti_layout_wrap'>
	<h3>
		<img src="../images/crm_pop5.gif" alt="전화" />
	...
	<h4>
		<div class="member_status">
			...
			<span><?=$result['name']?>(<?=$result['id']?>)회원 / </span><strong style="color:#ff4c3e;"><?=number_format($result['point'])?>P</strong>
			<a href="#" class="info_detail">상세내역 보기</a>
		</div>
	</h4>
	<form name='reserve' method='post' action='member_crm_act.php' id="point_form">
