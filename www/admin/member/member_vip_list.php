...
$count_where .= " and cmd.level_ix  in ('4','5','6')";
...
function delete_member_vip(code){
 	if(confirm('선택하신회원을 VIP회원에서 해제 하시겠습니까?')){
		window.frames['iframe_act'].location.href= 'member.act.php?act=delete_member_vip&code[]='+code;
 	}
}

function select_delete_member_vip(){
...
<table width='100%' border='0' align='center'>
  <tr>
    <td align='left' colspan=6 > ".GetTitleNavigation("불량고객관리", "회원관리 > 불량고객관리 ")."</td>
  </tr>
	    ...
	    <div class='tab'>
			...
			<tr>
				<td class='tab'>
					...
					<tr>
						<th class='box_01'></th>
						<td class='box_02'  ><a href='?info_type=list'>VIP회원리스트</a> <span style='padding-left:2px' class='helpcloud' help_width='410' help_height='70' help_html='사업자 정보를 작성하여 등록한 후에 해당 사업자에 관리자화면 로그인 정보를 발급해 줄 수 있습니다.<br />사업자 정보 추가 후 [목록관리] - [사용자 추가]를 통해 관리자에 계정을 발급해 주시기 바랍니다.'><img src='/admin/images/icon_q.gif' /></span></td>
						<th class='box_03'></th>
					</tr>
					</table>
...
$sql = "select
			...
			sum(if(md.level_ix in ('4','5','6'),1,0)) as member_cnt,
			sum(if(md.level_ix = '4',1,0)) as vip_cnt,
			sum(if(md.level_ix = '5',1,0)) as vvip_cnt,
			sum(if(md.level_ix = '6',1,0)) as vvvip_cnt
		from
			common_user as u 
...
<tr>
	<td colspan=8>
		...
		<tr>
			<td align='left' colspan=4 style='padding-bottom:5px;'> ".colorCirCleBox("#efefef","100%","<div style='padding:5px 5px 5px 15px;'><img src='../image/title_head.gif' ><b> VIP 회원 인원</b> ".($company_id != "" ? "[ ".$db->dt[com_name]." : ".$company_id." ]" : "")." </div>")."</td>
		  </tr>
		</table>
	</td>
</tr>
...
<tr height='27' bgcolor='#ffffff'>
    ...
    <td width='25%' align='center' class='m_td'><font color='#000000'><b>VIP</b></font></td>
    <td width='25%' align='center' class='m_td'><font color='#000000'><b>VVIP</b></font></td>
	<td width='25%' align='center' class='m_td' nowrap><font color='#000000'><b>VVVIP</b></font></td>
</tr>
<tr height='27'>
...
<tr>
	<td colspan=8>
		<table border='0' cellpadding='0' cellspacing='0' width='100%'>
		<tr>
			<td align='left' colspan=4 style='padding-bottom:5px;'> ".colorCirCleBox("#efefef","100%","<div style='padding:5px 5px 5px 15px;'><img src='../image/title_head.gif' ><b> VIP 회원 검색</b> ".($company_id != "" ? "[ ".$db->dt[com_name]." : ".$company_id." ]" : "")." </div>")."</td>
		  </tr>
		</table>
	</td>
</tr>
...
<input type='hidden' name='act' value='delete_member_vip'>
...
<table width='100%' border='0' cellpadding='0' cellspacing='0' align='center' >
  ...
  <tr height=30 >
	...
	$Contents .= "<a href='member_excel2003.php?page_type=member_vip_list&".$QUERY_STRING."'><img src='../images/".$admininfo["language"]."/btn_excel_save.gif' border=0></a>";
	}
	$Contents .= "
	</td>
  </tr>
...
<table width='100%' border='0' cellpadding='0' cellspacing='0' align='center' class='list_table_box'>
  <tr height='27' bgcolor='#ffffff'>
    ...
    <td width='4%' align='center' class='m_td'><font color='#000000'><b>순번</b></font></td>
    <td width='5%' align='center' class='m_td'><font color='#000000'><b>회원구분</b></font></td>
	<td width='9%' align='center' class='m_td'><font color='#000000'><b>회원그룹</b></font></td>
    ...
    <td width='8%' align='center' class=m_td><font color='#000000'><b>아이디</b></font></td>
    <td width='15%' align='center' class=m_td><font color='#000000'><b>이메일</b></font></td>
	<td width='7%' align='center' class=m_td><font color='#000000'><b>VIP설정일</b></font></td>
    <td width='7%' align='center' class=m_td><font color='#000000'><b>레벨구분</b></font></td>
	...
	$Contents .= "
	<td width='13%' align='center' class=e_td><font color='#000000'><b>관리</b></font></td>
	</tr>";
	...
	*/
	...
	//적립상태구분값(0:대기,1:적립,2:사용,9:취소)
		...
		$Contents = $Contents."
		  <tr height='27' onMouseOver=\"this.style.backgroundColor='#E8ECF1'; this.style.cursor='pointer'\" onMouseOut=\"this.style.backgroundColor=''\">
			...
			<td class='list_box_td' onClick=\"PopSWindow('member_view.php?code=".$db->dt[code]."',985,600,'member_info')\" nowrap>".$nationality."</td>
			...
			<td class='list_box_td point' onClick=\"PopSWindow('member_view.php?code=".$db->dt[code]."',985,600,'member_info')\" nowrap>".Black_list_check($db->dt[code],$db->dt[name])."</td>
			<td class='list_box_td' onClick=\"PopSWindow('member_view.php?code=".$db->dt[code]."',985,600,'member_info')\">".$db->dt[id]."</td>
			<td class='list_box_td' onClick=\"PopSWindow('member_view.php?code=".$db->dt[code]."',985,600,'member_info')\">".$db->dt[mail]."<font color=red> ".$is_id_auth."</font></td>
			...
			<td class='list_box_td ctr point' ><a href=\"javascript:PoPWindow('reserve.pop.php?code=".$db->dt[code]."',650,700,'reserve_pop')\">".number_format($db->dt[point])."</a></td>";
			}
			$Contents .= "
			...
			if(checkMenuAuth(md5($_SERVER["PHP_SELF"]),"U")){
				$Contents .= "<img src='../images/".$admininfo["language"]."/btn_clear.gif' border=0 align=absmiddle onClick=\"delete_member_vip('".$db->dt[code]."')\" alt='해제' title='해제'/>";
			}else{
				$Contents .= "<a href=\"".$auth_update_msg."\"><img src='../images/".$admininfo["language"]."/btn_clear.gif' border=0 align=absmiddle alt='해제' title='해제'></a> ";
			}
...
<table width=100%>
<tr>
	<td><a href=\"javascript:select_delete_member_vip();\">선택회원 VIP레벨해제</a><span style='padding-left:2px' class='helpcloud' help_width='300' help_height='20' help_html='VIP회원으로 등록된 회원을 해제 할 수 있습니다.'><img src='/admin/images/icon_q.gif' /></span></td>
	<td align=right>
	".$str_page_bar."
...
//$Contents .= HelpBox("VIP회원관리", $help_text,'70');
