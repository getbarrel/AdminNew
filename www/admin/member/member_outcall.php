...
$sql = "SELECT 
		...
		ON
		 (cmd.code = cu.code)
		where 1 $where AND lc.CTYPE IN (20,21)
		GROUP BY ACODE
		";
...
$account = $sdb->fetchall();
  ...
  <tr height='27' bgcolor='#ffffff'>
    ...
    <td width='10%' align='center' class='m_td'><font color='#000000'><b>발신시간</font></td>
    <td width='5%' align='center' class='m_td'><font color='#000000'><b>상담번호</b></font></td>
	<td width='10%' align='center' class='m_td' nowrap><font color='#000000'><b>전화번호</b></font></td>
    <td width='8%' align='center' class='m_td' nowrap><font color='#000000'><b>회원정보</b></font></td>
