			...
			<tr height=27>
				<td style='padding-left:20px;'>
					...
					<tr align='center' height='30'>
						...
						<td class='e_td'><input type='radio' name='basic_rate' id='basic_rate_8' value='8' style='position:relative;top:-2px;' ".($reserve_data[basic_rate] == "8" ? "checked":"")."><label for='basic_rate_8'>무료</label></td>
					</tr>
					<tr align='center' height='30'>
						<td class='list_box_td list_bg_gray'>웹사이트</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='goods_mileage_rate_1' value='".$reserve_data[goods_mileage_rate_1]."' style='width:40%;'> % </td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='goods_mileage_rate_2' value='".$reserve_data[goods_mileage_rate_2]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='goods_mileage_rate_3' value='".$reserve_data[goods_mileage_rate_3]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='goods_mileage_rate_4' value='".$reserve_data[goods_mileage_rate_4]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='goods_mileage_rate_5' value='".$reserve_data[goods_mileage_rate_5]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='goods_mileage_rate_6' value='".$reserve_data[goods_mileage_rate_6]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='goods_mileage_rate_7' value='".$reserve_data[goods_mileage_rate_7]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='goods_mileage_rate_8' value='".$reserve_data[goods_mileage_rate_8]."' style='width:40%;'> %</td>
					</tr>
					<tr align='center' height='30'>
						<td class='list_box_td list_bg_gray'>모바일</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='mobile_mileage_rate_1' value='".$reserve_data[mobile_mileage_rate_1]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='mobile_mileage_rate_2' value='".$reserve_data[mobile_mileage_rate_2]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='mobile_mileage_rate_3' value='".$reserve_data[mobile_mileage_rate_3]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='mobile_mileage_rate_4' value='".$reserve_data[mobile_mileage_rate_4]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='mobile_mileage_rate_5' value='".$reserve_data[mobile_mileage_rate_5]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='mobile_mileage_rate_6' value='".$reserve_data[mobile_mileage_rate_6]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='mobile_mileage_rate_7' value='".$reserve_data[mobile_mileage_rate_7]."' style='width:40%;'> %</td>
						<td class='list_box_td'><input type='text' class='textbox integer numeric' name='mobile_mileage_rate_8' value='".$reserve_data[mobile_mileage_rate_8]."' style='width:40%;'> %</td>
					</tr>
					</table>
				</td>
			</tr>
...
$Contents01 .= "
	...
	<col width='20%' />
	<col width='*' />
	<!--마일리지 관리 프로세스중 적립 대기 상태를 허용하지 않기 때문에 해당 기능은 사용하지 않음 JK160405-->
	<!--tr bgcolor='#ffffff'>
		...
		<td class='input_box_item' style='padding:5px;'>
			...
			<tr height=30>
				<td style='padding-left:5px;'> 
					- 일반 상품 구매 합계액이  <input type=text class='textbox number' name='total_order_price' value='".$reserve_data[total_order_price]."' style='width:60px;' validation='true' title='Mileage In-Use제한 설정'> 원 이상 상품 구매시사용 가능(무제한이일 경우 0원입력)
				</td>
			</tr>
			<!--<tr height=30>
				<td style='padding-left:5px;'>
					- 서비스 상품 구매 합계액이  <input type=text class='textbox number' name='service_total_order_price' value='".$reserve_data[service_total_order_price]."' style='width:60px;' validation='true' title='Mileage In-Use제한 설정'> 원 이상 상품 구매시사용 가능(무제한이일 경우 0원 입력)
				</td>
			</tr>-->
			<tr height=30>
				<td style='padding-left:5px;'> 
...
$Contents01 .= "
			...
			<input type='text' class='textbox number' name='order_member_mileage' value='".$reserve_data[order_member_mileage]."' style='width:70px;'>&nbsp;&nbsp; 미만인 회원은 휴면회원으로 간주하여 회사는 해당 회원의 적립된 마일리지를 회수 합니다.
		</td>
	</tr>
...
//$Script = "<script language='javascript' src='../basic/basicinfo.js'></script>";
$P = new LayOut();
$P->addScript = $Script;
