			...
			<div class='tab'>
				...
				<tr>
					<td class='tab'>
						...
						<tr>
							<th class='box_01'></th>
							<td class='box_02'  ><a href='member_black_list.php?info_type=list'>블랙리스트</a> <span style='padding-left:2px' class='helpcloud' help_width='410' help_height='70' help_html='사업자 정보를 작성하여 등록한 후에 해당 사업자에 관리자화면 로그인 정보를 발급해 줄 수 있습니다.<br />사업자 정보 추가 후 [목록관리] - [사용자 추가]를 통해 관리자에 계정을 발급해 주시기 바랍니다.'><img src='/admin/images/icon_q.gif' /></span></td>
							<th class='box_03'></th>
						</tr>
						</table>
...
<tr>
	<td colspan=8>
		...
		<tr>
			<td align='left' colspan=4 style='padding-bottom:5px;'> ".colorCirCleBox("#efefef","100%","<div style='padding:5px 5px 5px 15px;'><img src='../image/title_head.gif' ><b>블랙회원 수동등록관리</b> ".($company_id != "" ? "[ ".$db->dt[com_name]." : ".$company_id." ]" : "")." </div>")."</td>
		  </tr>
		</table>
	</td>
</tr>
...
<input type='hidden' name='act' value='black_update'>
	...
	<td class='search_box_item'>
		...
		<tr>
			<td width='300'>
				...
				<tr align='right'>
					<td width='240'>
						<img src='../v3/images/korea/btn_member_search.gif' align='absmiddle' onclick=ShowModalWindow('./charger_search.php?company_id=3444fde7c7d641abc19d5a26f35a12cc&target=7&amp;code=',700,530,'charger_search') style='cursor:pointer;'>
					</td>
					<td align='center'>
				...
				<tr>
					<td colspan='2'>
						<select name='black_delete[]' style='border:solid 1px #ddd;width:300px;height:148px;font-size:12px;background:#fff;' class='participation' id='participation'  multiple>
			...
			<td align='center'>
				<div class='float01 email_btns01'>
					<ul>
						<li>
							<a href=\"javascript:MoveSelectBox('ADD','7');\"><img src='../images/icon/pop_plus_btn.gif' alt='추가' title='추가' /></a>
						</li>
						<li>
							<a href=\"javascript:MoveSelectBox('REMOVE','7');\"><img src='../images/icon/pop_del_btn.gif' alt='삭제' title='삭제' /></a>
						</li>
					</ul>
				</div>
			</td>
			...
			<td width='300'>
				...
				<tr align='left'>
					<td width='230'>
						<img src='../images/dot_org.gif' align=absmiddle> <b class='middle_title'>블랙1 회원</b>
					</td>
				</tr>
				<tr>
					<td colspan='2'>
						<select name='black_list[]' style='border:solid 1px #ddd;width:300px;height:148px;font-size:12px;background:#fff;' id='selected' validation=true title='vip회원 대상' multiple>
						";
						$vip_array = get_vip_member('7');
	...
	<td class='search_box_item'>
		...
		<tr>
			<td width='300'>
				...
				<tr align='right'>
					<td width='240'>
						<img src='../v3/images/korea/btn_member_search.gif' align='absmiddle' onclick=ShowModalWindow('./charger_search.php?company_id=3444fde7c7d641abc19d5a26f35a12cc&target=8&amp;code=',700,530,'charger_search') style='cursor:pointer;'>
					</td>
					<td align='center'>
				...
				<tr>
					<td colspan='2'>
						<select name='black1_delete[]' style='border:solid 1px #ddd;width:300px;height:148px;font-size:12px;background:#fff;' id='participation_1' class='participation_1' multiple>
						</select>
					</td>
				</tr>
				</table>
			...
			<td align='center'>
				<div class='float01 email_btns01'>
					<ul>
						<li>
							<a href=\"javascript:MoveSelectBox('ADD','8');\"><img src='../images/icon/pop_plus_btn.gif' alt='추가' title='추가' /></a>
						</li>
						<li>
							<a href=\"javascript:MoveSelectBox('REMOVE','8');\"><img src='../images/icon/pop_del_btn.gif' alt='삭제' title='삭제' /></a>
						</li>
					</ul>
				</div>
			</td>
			...
			<td width='300'>
				...
				<tr align='left'>
					<td width='230'>
						<img src='../images/dot_org.gif' align=absmiddle> <b class='middle_title'>블랙2 회원</b>
					</td>
				</tr>
				<tr>
					<td colspan='2'>
						<select name='black1_list[]' style='border:solid 1px #ddd;width:300px;height:148px;font-size:12px;background:#fff;' id='selected_1' validation=true title='메일수신 대상' multiple>
							";
						$vip_array = get_vip_member('8');
						for($i = 0; $i<count($vip_array); $i++){
							$Contents .="<option value='".$vip_array[$i][code]."'>".$vip_array[$i][name]."(".$vip_array[$i][id].")</option>";
						}
						$Contents .="
	...
	<td class='search_box_item'>
		...
		<tr>
			<td width='300'>
				...
				<tr align='right'>
					<td width='240'>
						<img src='../v3/images/korea/btn_member_search.gif' align='absmiddle' onclick=ShowModalWindow('./charger_search.php?company_id=3444fde7c7d641abc19d5a26f35a12cc&target=9&amp;code=',700,530,'charger_search') style='cursor:pointer;'>
					</td>
					<td align='center'>
				...
				<tr>
					<td colspan='2'>
						<select name='black2_delete[]' style='border:solid 1px #ddd;width:300px;height:148px;font-size:12px;background:#fff;' id='participation_2' class='participation_2' multiple>
						</select>
					</td>
				</tr>
				</table>
			...
			<td align='center'>
				<div class='float01 email_btns01'>
					<ul>
						<li>
							<a href=\"javascript:MoveSelectBox('ADD','9');\"><img src='../images/icon/pop_plus_btn.gif' alt='추가' title='추가' /></a>
						</li>
						<li>
							<a href=\"javascript:MoveSelectBox('REMOVE','9');\"><img src='../images/icon/pop_del_btn.gif' alt='삭제' title='삭제' /></a>
						</li>
					</ul>
				</div>
			</td>
			...
			<td width='300'>
				...
				<tr align='left'>
					<td width='230'>
						<img src='../images/dot_org.gif' align=absmiddle> <b class='middle_title'>블랙3 회원</b>
					</td>
				</tr>
				<tr>
					<td colspan='2'>
						<select name='black2_list[]' style='border:solid 1px #ddd;width:300px;height:148px;font-size:12px;background:#fff;' id='selected_2' validation=true title='메일수신 대상' multiple>
						";
						$vip_array = get_vip_member('9');
						for($i = 0; $i<count($vip_array); $i++){
							$Contents .="<option value='".$vip_array[$i][code]."'>".$vip_array[$i][name]."(".$vip_array[$i][id].")</option>";
						}
						$Contents .="
