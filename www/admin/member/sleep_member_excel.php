...
for($i=0;$i<$db->total;$i++){
    ...
    $memberXL->getActiveSheet()->setCellValue('E' . ($i + 2), wel_masking_seLen($db->dt[name], 1, 1));
    ...
    $memberXL->getActiveSheet()->setCellValue('O' . ($i + 2), wel_masking("P", $db->dt[pcs]));
}
...
//$objWriter->save('php://output');
	...
	//	ig 엑셀 파일 zip 파일로 생성 후 패스워드 걸기	방법2
		$download_filename = 'sleep_members_'.$info_type.date("YmdHis").'.zip'; 
		$igExcel_file = '../excelDn/sleep_members_'.$info_type.'.xls'; 
