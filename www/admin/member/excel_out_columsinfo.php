...
if($info_type == "deposit_info"){
...
}else if($info_type == 'member'){

	$colums[gp_name] = array(value=>'gp_name',title=>'회원그룹', checked=>'checked');
	$colums[nationality] = array(value=>'nationality',title=>'국내/해외', checked=>'checked');
	...
	$colums[authorized] = array(value=>'authorized',title=>'승인여부', checked=>'checked');
	$colums[name] = array(value=>'name',title=>'이름', checked=>'checked');
	$colums[id] = array(value=>'id',title=>'아이디', checked=>'checked');
	$colums[mail] = array(value=>'mail',title=>'이메일', checked=>'checked');
	$colums[pcs] = array(value=>'pcs',title=>'핸드폰번호', checked=>'checked');
	$colums[last] = array(value=>'last',title=>'최근방문일', checked=>'checked');
	$colums[visit] = array(value=>'visit',title=>'로그인수', checked=>'checked');
	$colums[mileage] = array(value=>'mileage',title=>'마일리지', checked=>'checked');
	$colums[point] = array(value=>'point',title=>'포인트', checked=>'checked');
	$colums[date] = array(value=>'date',title=>'회원가입일', checked=>'checked');
	$colums[birthday] = array(value=>'birthday',title=>'생일', checked=>'checked');
	$colums[code] = array(value=>'code',title=>'회원코드', checked=>'checked');
