...
$Contents02 .= "
	...
	if($mmode != "personalization"){ 
		if(checkMenuAuth(md5($_SERVER["PHP_SELF"]),"E")){
			...
			$Contents02 .= "<a href='javascript:ig_excel_dn_chk(\"mileage_excel2016.php?".$QUERY_STRING."\");'><img src='../images/".$admininfo["language"]."/btn_excel_save.gif' border=0></a>";
		}else{
...
if($mmode != "personalization"){ 
$Contents02 .= "
				<td class='list_box_td point' bgcolor='#efefef'><a href=\"javascript:PoPWindow('mileage.pop.php?code=".$db->dt[code]."',750,550,'mileage_pop')\">".wel_masking_seLen($db->dt[name], 1, 1)."</a></td>
