...
$db->query("SELECT * FROM service_category_info where depth in(0,1,2,3)  order by vlevel1, vlevel2, vlevel3, vlevel4, vlevel5");
...
$Contents = "
		...
		<tr>
			...
			<td valign=top width='100%' align='left' style=''>
				...
				<form name='thisCategoryform' method=\"post\" enctype='multipart/form-data' action='service_category.save.php' target='calcufrm' style='display:inline;'>
				<input type='hidden' name='mode' value=''>
				<input type='hidden' name='this_depth' value=''>
				<input type='hidden' name='cid' value=''>
...
$Contents .= "
				...
				<form name='subCategoryform' method=\"post\" enctype='multipart/form-data' action='service_category.save.php' target='calcufrm' style='display:inline;'>
				<input type='hidden' name='mode' value=''>
...
$Contents .= "
				...
				<div class='doong'  id='input_addfield' style='display:none;'>
					<form name='add_field' method=\"post\" enctype='multipart/form-data' action='service_category.save.php' onsubmit='return SaveAddField(this);' target='calcufrm'>
...
if($view == "innerview"){
	...
	<script language='JavaScript' src='service_category.js'></script>
