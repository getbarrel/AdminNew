...
<table cellpadding=1 cellspacing=0 class='small' >
	...
	<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' >최근게시물 관리에 노출여부를 노출함 으로 선택하신 게시판만 최근게시물에 노출되게 됩니다</td></tr>
</table>
";
*/
$help_text = getTransDiscription(md5($_SERVER["PHP_SELF"]),'A');

$mstring .= HelpBox("최근 게시물 관리", $help_text);
...
function PrintBoardRecentList(){
	...
	$sql = "select * from bbs_manage_config bmc , bbs_group bg where bmc.board_group = bg.div_ix and disp = 1 and bmc.board_style = 'bbs' and bmc.recent_list_display = 'Y' ";
	$mdb->query($sql);
