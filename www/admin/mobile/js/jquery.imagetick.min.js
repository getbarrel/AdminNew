...
if(disable){$(this).attr('disabled','disabled');method_type='add';}
...
$input_id.trigger("click");handleClickType.call(this,using_custom_btn,type,$input_id);});if(opt.act_value!="") {$img_id.click(function(){eval(opt.act_value)})};if($label.length){$label.click(function(e){e.preventDefault();$img_id.trigger('click');});}});};})(jQuery);