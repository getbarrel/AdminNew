...
if($page_type == 'input'){
	...
	$goods_basic_sample[] = array("code"=>"regist_company_id","title"=>"입고창고(사업장)","desc"=>"","type"=>"","comment"=>"입고창고 키값 
	(주)한웰이쇼핑 : 362ed8ee1cba4cc34f80aa5529d2fbcd ","validation"=>"true","sample"=>"362ed8ee1cba4cc34f80aa5529d2fbcd");

	$goods_basic_sample[] = array("code"=>"regist_pi_ix","title"=>"입고창고(창고)","desc"=>"","type"=>"","comment"=>"남사물류센터 : 1
기흥물류 : 2
본사샘플 : 3","validation"=>"true","sample"=>"1");
	...
	$goods_basic_sample[] = array("code"=>"h_type","title"=>"입고유형","desc"=>"","type"=>"","comment"=>"01 : 상품매입
02 : 샘플
03 : 기증
04 : 반품
05 : 교환
...
07 : 대여
08 : 환출
17 : 생산입고","validation"=>"true","sample"=>"01");
...
5 : 부가세 없음","validation"=>"false","sample"=>"1");
	...
	$goods_basic_sample[] = array("code"=>"amount","title"=>"입고수량","desc"=>"","type"=>"","comment"=>"입고할 수량을 입력해주세요.","validation"=>"true","sample"=>"10");
