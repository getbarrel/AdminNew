...
$seller_type[0] = "1";	//국내매출 출고처 구분값 지정
...
<table width='100%' border='0' align='center'>
  <tr>
    <td align='left' colspan=6 > ".GetTitleNavigation("출고처 리스트", "재고관리 > 출고처관리 ")."</td>
  </tr>
	<tr>
		<td align='left' colspan=4 style='padding-bottom:20px;'> 
			...
			<tr>
				...
				<td class='btn'>
					...
					<tr>
						<th class='box_01'></th>
						<td class='box_02' onclick=\"document.location.href='seller.list.php'\">출고처 리스트</td>
						<th class='box_03'></th>
					</tr>
					</table>
				</td>
...
$Contents .= HelpBox("출고처 관리", $help_text,'70');
