...
if($act == "cookie_setting" || $act == "delivery_cookie_setting" || $act == "stock_report_setting"){
	...
	*/
	...
	$sql = "REPLACE INTO inventory_config set charger_ix='".$admininfo[charger_ix]."' , conf_name='inventory_excel_".$info_type."',conf_val='".serialize($inventory_excel_info)."'  ";
	//echo $sql;
	$db->query($sql);

	$sql = "REPLACE INTO inventory_config set charger_ix='".$admininfo[charger_ix]."' , conf_name='inventory_excel_checked_".$info_type."',conf_val='".serialize($colums)."'  ";
	//echo $sql;
	$db->query($sql);
