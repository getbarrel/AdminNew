						...
						<div class='tab'>
							...
							<tr>
								<td class='tab'>
									...
									<tr>
										<th class='box_01'></th>
										<td class='box_02'  ><a href='?info_type=basic&company_id=".$company_id."&mmode=$mmode'>&nbsp;&nbsp;본부/부서&nbsp;&nbsp; </a></td>
										<th class='box_03'></th>
									</tr>
									</table>
									...
									<tr>
										...
										<td class='box_02' >";
										if($company_id == ""){
											$Contents01 .= "<a href='?info_type=post_info&company_id=".$company_id."&mmode=$mmode'>&nbsp;&nbsp;직위&nbsp;&nbsp; </a>";
										}else{
											$Contents01 .= "<a href='?info_type=post_info&company_id=".$company_id."&mmode=$mmode'>&nbsp;&nbsp;직위&nbsp;&nbsp; </a>";
										}
										$Contents01 .= "
									...
									<tr>
										...
										<td class='box_02' >";
										if($company_id == ""){
											$Contents01 .= "<a href='?info_type=position_info&company_id=".$company_id."&mmode=$mmode'>&nbsp;&nbsp;직책&nbsp;&nbsp; </a>";
										}else{
											$Contents01 .= "<a href='?info_type=position_info&company_id=".$company_id."&mmode=$mmode'>&nbsp;&nbsp;직책&nbsp;&nbsp; </a>";
										}
										$Contents01 .= "
	...
	<col width='*' />
	  ...
	  <tr bgcolor=#ffffff >
		...
		<tr>
			...
			<td class='input_box_item' colspan='3'>
				<input type=text class='textbox' name='group_name' value='".$group_name."' validation='true' title='부서 그룹명' style='width:200px'>
			</td>
		</tr>
	  <tr bgcolor=#ffffff >
...
$select = "
	<select name='update_type' >
		...
		<option value='2' selected>선택한 본부/부서, 직위 전체에</option>
...
$select_contents .= "".HelpBox($select, $help_text,300)."";
...
$('#depart_update').click(function(){
	...
	$('#department_group').attr('validation','true');
});

$('#com_group').click(function(){
	$('#department_group').attr('disabled',true);
	$('#department_group').attr('validation','false');
});
...
$('#department_group').attr('title','본부');
$('#'+($('input[name=company_group]:checked').attr('id'))).trigger('click');
...
$P->Navigation = "기초정보관리 > 기초관리 > 기초부서관리";
$P->title = "기초부서관리";
