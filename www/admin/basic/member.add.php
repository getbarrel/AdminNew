...
if($admininfo['charger_roll'] == '1' || $admininfo['charger_roll'] == '13' || $admininfo['charger_roll'] == '14' || $admininfo['charger_roll'] == '15' || $admininfo['charger_roll'] == '16' || $admininfo['charger_roll'] == '17' || $admininfo['charger_roll'] == '18' || $admininfo['charger_roll'] == '26' || $admininfo['charger_roll'] == '32') {
} else {
	echo("<script>alert('접근이 차단된 권한입니다.');location.href = '/admin/store/main.php';</script>");
	exit;
}
					...
					<tr>
						<td>
							...
							<tr>
								...
								<td class='input_box_title'> <b>OTP키</b></td>
								<td class='input_box_item'>
								<input type=text name='otpkey' value='".$db->dt[otpkey]."' class='textbox'  style='width:100px' validation='false'>
								</td>
							</tr>
							</table>
						</td>
