...
<table class='layer_box' border=0 cellpadding=0 cellspacing=0 style='width:880px;' >
	<col width='11px'>
	<col width='*'>
	<col width='11px'>
	<tr>
	...
	<tr>
		<th class='box_04' style='vertical-align:top;height:10px;'></th>
		...
		<form name='excel_out_frm' method=\"post\" enctype='multipart/form-data' action='../order/excel_out.act.php' onsubmit='return CheckValue(this);' target='act' >
...
$Contents .= "<span class='helpcloud' help_height='30' help_width='200' help_html='저장된 엑셀 설정정보를 삭제하시면 초기 셋팅값이 노출되게 됩니다.  '> <img src='../images/".$_SESSION["admininfo"]["language"]."/b_del.gif' border=0 align=absmiddle style='cursor:pointer' onclick=\"deleteSettingInfo('delete_setting', '$excel_type')\"></span>";
$Contents .="	
...
function deleteSettingInfo(act,excel_type){
	if(confirm('엑셀설정정보를 정말로 삭제하시겠습니까?')){
		window.frames['act'].location.href='./excel_out.act.php?act='+act+'&excel_type='+excel_type; 
	}
}
