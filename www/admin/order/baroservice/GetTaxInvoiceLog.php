<?php
	...
	try {
		...
		// Soap 문장 전송
		$result = $client->call('GetTaxInvoiceLog', $params, '', '', false, true);
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				$GetTaxInvoiceLogResult = $result['GetTaxInvoiceLogResult'];	
				if($GetTaxInvoiceLogResult == ""){
					$errCode = errCodeCheck($GetTaxInvoiceLogResult);
						echo $errCode;
				}
