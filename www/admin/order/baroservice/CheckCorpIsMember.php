<?php
	...
	try {		
		...
		// Soap 문장 전송		
		$result = $client->call('CheckCorpIsMember', $params, '', '', false, true);
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				$CheckCorpIsMemberResult = $result['CheckCorpIsMemberResult'];				
				switch ($CheckCorpIsMemberResult) {
					case -1:
						echo "휴/폐업";
						break;
					case -2:
					...
					case 1:
						...
						break;
					default:
						$errCode = errCodeCheck($CheckCorpIsMemberResult);
						echo $errCode;
						break;
				}
			}
