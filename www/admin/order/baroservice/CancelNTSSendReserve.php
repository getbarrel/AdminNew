<?php
	...
	try {
		...
		// Soap 문장 전송
		$result = $client->call('CancelNTSSendReserve', $params, '', '', false, true);
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				$CancelNTSSendReserveResult = $result['CancelNTSSendReserveResult'];				
				switch ($CancelNTSSendReserveResult) {
					case 1:
						echo "예약 취소 완료";
						break;
					default:
						$errCode = errCodeCheck($CancelNTSSendReserveResult);
echo $errCode;
						break;
				}
			}
