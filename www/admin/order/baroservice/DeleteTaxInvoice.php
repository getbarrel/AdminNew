<?php
	...
	try {		
		...
		// Soap 문장 전송		
		$result = $client->call('DeleteTaxInvoice', $params, '', '', false, true);
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				$DeleteTaxInvoiceResult = $result['DeleteTaxInvoiceResult'];				
				switch ($DeleteTaxInvoiceResult) {
					case 1:
						echo "삭제 완료(임시저장)";
						break;
					case 1:
						...
						break;
					default:
						$errCode = errCodeCheck($DeleteTaxInvoiceResult);
						echo $errCode;
						break;
				}
			}
