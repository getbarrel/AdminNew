<?php
	...
	try {
		...
		// Soap 문장 전송
		$result = $client->call('AddUserToCorp', $params, '', '', false, true);
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				$AddUserToCorpResult = $result['AddUserToCorpResult'];				
				switch ($AddUserToCorpResult) {
					case 1:
						echo "등록성공";
						break;
					default:
						$errCode = errCodeCheck($AddUserToCorpResult);
						echo $errCode;
						break;
				}
			}
