	...
	try {
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				echo "<br />발행자 관리번호 :". $GetTaxInvoiceStateResult['MgtKey'];
				echo "<br />반환값 :". $GetTaxInvoiceStateResult['RetVal'];
				echo "<br />바로빌 관리번호 :". $GetTaxInvoiceStateResult['InvoiceKey'];
				echo "<br />비고1 :". $GetTaxInvoiceStateResult['Remark1'];
				echo "<br />비고2 :". $GetTaxInvoiceStateResult['Remark2'];
