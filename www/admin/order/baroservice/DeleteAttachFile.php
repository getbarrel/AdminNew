<?php
	...
	try {
		...
		// Soap 문장 전송
		$result = $client->call('DeleteAttachFile', $params, '', '', false, true);
		...
		if ($client->fault) {
			...
			if ($err) {
				...
				$DeleteAttachFileResult = $result['DeleteAttachFileResult'];				
				switch ($DeleteAttachFileResult) {
					case 0:
						echo "첨부파일이 없습니다.";
						break;
					case 1:
						...
						break;
					default:
						$errCode = errCodeCheck($DeleteAttachFileResult);
						echo $errCode;
						break;
				}
			}
