...
<div class='modal-content'>
	<div class='madal-totle-box'>
		<h2 class='modal-title'><img src='../images/korea/packing-title.png' alt='' /></h2>
	...
	<div class='madal-top'>
		<form name='invoice_frm' method='post' action='../order/picking_barcode_invoice.iframe.php' target='order_view' style='margin:0;'>
			...
			<div class='mt_top_title'>
				<h3>송장번호입력</h3>
				<div class='modal-checkbox'><input type='checkbox' checked='' name='auto_set' value='Y' id='auto_set' /> <label for='auto_set'>주문수량=체크수량 동일시 자동 출고대기 처리</label></div>
			</div>
			<div class='mt_top_content'>
				<span class='p-num-box'><input type='text' name='invoice_no' id='invoice_no' class='p-num-input' value='' /></span>
				<span class='system-box'><div id='sys_msg_text' class='massege-box' style='color:#000'>&nbsp;</div></span>
				<span id='set_butten_no_tr'  class='post-btn'><img src='../images/korea/packing-btn.gif' alt='포장검수확인' /></span>
				<span id='set_butten_tr' class='post-btn' style='display:none;'><img src='../images/korea/packing-btn.gif' alt='포장검수확인' onclick=\"$('form[name=invoice_frm]').submit();\" style='cursor:pointer;' /></span>
			</div>
		</form>
	</div>
	<div id='iframe_div' class='packing-view'>
		<iframe name='order_view' id='order_view' style='width:100%;height:400px' frameborder='0' src='../order/picking_barcode_invoice.iframe.php' ></iframe>
	</div>
</div>
";
