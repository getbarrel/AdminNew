...
//define("NICEPAY_DOMAIN_NAME","pgbiz.mnbank.co.kr");
define("NICEPAY_DOMAIN_NAME","211.33.136.39");
//define("NICEPAY_DOMAIN_NAME","172.31.61.90");
...
define("SERVICEAMT", "ServiceAmt");
define("SUPPLYAMT", "SupplyAmt");
define("GOODSVAT", "GoodsVat");
define("CARTCNT", "CartCnt");
define("ACQUREQDATE", "AcquReqDate");
...
define("LOG_DIRECTORY_CONF_NAME","${nicepay.log.dir}");
