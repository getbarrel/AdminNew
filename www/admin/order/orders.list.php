								...
								<TABLE>
									<TR>
										<TD align='center'>
											...
											<a  href='".$front_url."/shop/goodsView/".$order_list[$i][pid]."' class='screenshot'  rel='".PrintImage($admin_config[mall_data_root]."/images/addimgNew".$addQaDir, $order_list[$i][pid], 'list',$order_list[$i])."'  target=_blank><img src='".PrintImage($admin_config[mall_data_root]."/images/addimgNew".$addQaDir, $order_list[$i][pid], 'slist',$order_list[$i])."'  width=50 style='margin:5px;'></a><br/>";
