...
require_once 'bankda_m.php';
require_once 'mallstory_m.php';
*/
require_once($_SERVER["DOCUMENT_ROOT"]."/admin/order/bankda/src/config.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/admin/order/bankda/src/bankda_m.php");
require_once($_SERVER["DOCUMENT_ROOT"]."/admin/order/bankda/src/mallstory_m.php");

class bankda{
	public $model;
	private $mallstoryModel;
	private $shopIx;
	private $mallDataRoot;
	...
	public function __construct(){
		$this->model = new bankda_m();		
		$this->mallstoryModel = new mallstory_m(); //뱅크다 공통 테이블 DB
	...
	public function getUserInfo(){
		return $this->mallstoryModel->userInfo($this->shopIx);
	}
	/**
	 * 회원코드로 쇼핑몰 회원정보 가져오기
	 * @param string	ucode
