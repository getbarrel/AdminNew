...
$mstring .="<table cellpadding=5 cellspacing=0 width=100% border=0 align=center>
		<tr>
			<td align='left' colspan=6 >".GetTitleNavigation("바이럴 광고", "마케팅지원 > 바이럴 광고 ")."</td>
		</tr>
		<tr>
			    ...
			    <div class='tab'>
					...
					<tr>
						<td class='tab'>
							...
							<tr>
								<th class='box_01'></th>
								<td class='box_02' onclick=\"document.location.href='?regdate=$month'\">바이럴 광고 안내</td>
								<th class='box_03'></th>
							</tr>
							</table>
							...
							<tr>
								<th class='box_01'></th>
								<td class='box_02' onclick=\"document.location.href='?regdate=".$month_1."'\">바이럴 광고 신청</td>
								<th class='box_03'></th>
							</tr>
							</table>
		...
		<tr>
			<td>
				<div class='contentsbox_area'>
					...
					<div class='title_01'>
						<strong>바이럴 광고 마케팅이란?</strong>
					</div>
					<div>
						<img src='../images/marketing/viral_img.jpg' alt='바이럴 광고 마케팅' title='바이럴 광고 마케팅' class='img_box'/>
					</div>
				</div>
			</td>
		</tr>
