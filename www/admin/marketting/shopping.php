...
$mstring .="<table cellpadding=5 cellspacing=0 width=100% border=0 align=center>
		<tr>
			<td align='left' colspan=6 >".GetTitleNavigation("쇼핑광고", "마케팅지원 > 쇼핑광고 ")."</td>
		</tr>
		<tr>
			    ...
			    <div class='tab'>
					...
					<tr>
						<td class='tab'>
							...
							<tr>
								<th class='box_01'></th>
								<td class='box_02' onclick=\"document.location.href='?regdate=$month'\">쇼핑광고 안내</td>
								<th class='box_03'></th>
							</tr>
							</table>
							...
							<tr>
								<th class='box_01'></th>
								<td class='box_02' onclick=\"document.location.href='?regdate=".$month_1."'\">쇼핑광고 신청</td>
								<th class='box_03'></th>
							</tr>
							</table>
...
$mstring .="<table cellpadding=5 cellspacing=0 width=100% border=0 align=center>
	...
	<div>
		<img src='../images/marketing/shopping_ads_img.jpg' alt='쇼핑광고' title='쇼핑광고' class='img_box'/>
	</div>
</div>
			</td>
		</tr>
