...
$mstring .="<table cellpadding=5 cellspacing=0 width=100% border=0 align=center>
		<tr>
			<td align='left' colspan=6 >".GetTitleNavigation("네트워크포탈", "마케팅지원 > 네트워크포탈 ")."</td>
		</tr>
		<tr>
			    ...
			    <div class='tab'>
					...
					<tr>
						<td class='tab'>
							...
							<tr>
								<th class='box_01'></th>
								<td class='box_02' onclick=\"document.location.href='?regdate=$month'\">네트워크포탈 안내</td>
								<th class='box_03'></th>
							</tr>
							</table>
							...
							<tr>
								<th class='box_01'></th>
								<td class='box_02' onclick=\"document.location.href='?regdate=".$month_1."'\">네트워크포탈 신청</td>
								<th class='box_03'></th>
							</tr>
							</table>
				...
				<div class='contentsbox_area'>
					...
					<table cellpadding='0' cellspacing='0' border='0' width='100%' class='application_box'>
						...
						<tr>
							...
							<td>
								<a href='#'><img src='../images/marketing/apply_now_btn.gif' alt='빠른상담 신청하기' title='빠른상담 신청하기' /></a>
							</td>
						</tr>
					</table>
					<div class='title_01'>
						<strong>네트워크포탈 마케팅이란?</strong>
					</div>
					<div>
						<img src='../images/marketing/network_img01.jpg' alt='네트워크포탈 마케팅' title='네트워크포탈 마케팅' class='img_box'/>
					</div>
				</div>
			</td>
		</tr>
