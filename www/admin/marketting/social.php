...
$mstring .="<table cellpadding=5 cellspacing=0 width=100% border=0 align=center>
		<tr>
			<td align='left' colspan=6 >".GetTitleNavigation("소셜마케팅", "마케팅지원 > 소셜마케팅 ")."</td>
		</tr>
		<tr>
			    ...
			    <div class='tab'>
					...
					<tr>
						<td class='tab'>
							...
							<tr>
								<th class='box_01'></th>
								<td class='box_02' onclick=\"document.location.href='?regdate=$month'\">소셜마케팅 안내</td>
								<th class='box_03'></th>
							</tr>
							</table>
							...
							<tr>
								<th class='box_01'></th>
								<td class='box_02' onclick=\"document.location.href='?regdate=".$month_1."'\">소셜마케팅 신청</td>
								<th class='box_03'></th>
							</tr>
							</table>
...
$mstring .="
		...
		<tr>
			<td>
				...
				<div class='title_01'>
					<strong>SNS 마케팅이란?</strong>
				</div>
				<div>
					<img src='../images/marketing/social_img.jpg' alt='SNS 마케팅' title='SNS 마케팅' class='img_box'/>
				</div>
			</div>
		</tr>
		</table>
