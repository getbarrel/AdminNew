...
var defaults = {
	...
	titleFormat: {
		month: 'yyyy년 MMMM ',
		week: "yyyy. MM. d [ yyyy]{ '-'  yyyy. MMM. d}",
	...
	dayNames: ['일(Sun)','월(Mon)','화(Tue)','수(Wed)','목(Thu)','금(Fri)','토(Sat)'],
...
function Header(calendar, options) {
	...
	function render() {
		...
		//alert(print_r(sections));
		if (sections) {
			element = $("<table class='fc-header'/>")
				.append($("<tr/>")
					.append($("<td class='fc-header-left' style='padding-left:10px;'/>")
						.append(renderSection(sections.left)))
					.append($("<td class='fc-header-center'/>")
						.append(renderSection(sections.center)))
					.append($("<td class='fc-header-right' style='text-align:right;vertical-align:bottom;padding:0px 10px 7px 0px'><input type=checkbox name='with_work' id='calendar_with_work' onclick='ToggleWorkJob();'><label for='calendar_with_work'>업무포함</label></td>")
...
function AgendaView(element, calendar, viewName) {
	...
	function renderAgenda(c) {
		...
		if (!head) { // first time rendering, build from scratch
			...
			s += "</table>";
			body = $("<div class='fc-agenda-body' style='position:relative;z-index:2;overflow:hidden'/>")
