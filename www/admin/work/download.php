...
session_start();
if($wc_ix){
	$localfilepath = $_SERVER["DOCUMENT_ROOT"].$admin_config[mall_data_root]."/work/".$data_type."/".$wc_ix."/".iconv('UTF-8','EUC-KR',$data_file);
}else if($wr_ix){
	$localfilepath = $_SERVER["DOCUMENT_ROOT"].$admin_config[mall_data_root]."/work/".$data_type."/".$wr_ix."/".iconv('UTF-8','EUC-KR',$data_file);
}
//echo $localfilepath;
