...
<table width='100%' cellpadding=0 cellspacing=0 border='0' align='center'>
  <tr>
    <td align='left' colspan=6 > ".GetTitleNavigation(" 컴멘트 목록", "업무관리 >  컴멘트 목록 ")."
...
<table width=100% cellpadding='0' cellspacing=0 border=0>
	...
	<tr>
		<td align='left' colspan=2 style='vertical-align:top;padding:20px 0px 20px 0px;'> 
	    	".LiveComment()."
	    </td>
	</tr>
