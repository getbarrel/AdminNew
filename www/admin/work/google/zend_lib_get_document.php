<?php
GoogleDocument('gooody@gmail.com', 'tlsgnstlr');
function GoogleDocument($google_mail, $google_pass){
	//global $chargerinfo;
    // load library
	include($_SERVER["DOCUMENT_ROOT"]."/class/database.class");
	ini_set('include_path', ".:/usr/local/lib/php:".$_SERVER["DOCUMENT_ROOT"]."/include/pear:".$_SERVER["DOCUMENT_ROOT"]."/admin/work:".$_SERVER["DOCUMENT_ROOT"]."/admin/work/Zend");
	...
	$ss = new Google_Spreadsheet($google_mail,$google_pass); 
