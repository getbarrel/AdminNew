...
<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
					...
					<table width='100%' border='0' cellspacing='0' cellpadding='0' >
						<tr> 
							<td width='10%' height='31' valign='middle' style='font-family:굴림;font-size:16px;font-weight:bold;letter-spacing:-2px;word-spacing:0px;padding-left:10px;' nowrap><!--border-bottom:2px solid #ff9b00;-->
								<img src='/admin/images/icon/sub_title_dot.gif' align=absmiddle> 보고서 메일보내기
							</td>
	...
	<tr><form name='send_mail' method='post' action='work_mail.act.php' onsubmit="return CheckMail(this);" ><input type=hidden name='act' value='send_mail' >
		<td align=center style='padding:5px 10px 5px 10px'>
		<table width=100% cellpadding=0 cellspacing=0>
			<tr height=25><td width='13%'><b>메일 제목 :</b> </td><td><input type=text name='mail_subject' class='textbox'  value='' style='width:100%;'></td></tr>
			<tr height=25><td width='13%'><b>받는 사람 :</b> </td><td><input type=text name='target_mails' class='textbox'  value='' style='width:100%;'></td></tr>
		</table>
		</td>
	</tr>
	<!--tr>
...
<textarea  name='b_contents' style='display:none;' ><?=$b_contents?>
</textarea>
<?=miniWebEdit("..",500)?>
		</td>
	</tr>
