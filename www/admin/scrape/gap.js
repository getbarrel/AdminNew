...
//var url = 'http://www.gap.com/browse/product.do?cid=34740&vid=1&pid=918399022';
					...
					var result = page
							.evaluate(function() {
								...
								function Gap() {
									this.name = "";
									this.pid = "";
									//this.images = new Images();//@edit 2013.10.28 bgh
								...
								for (i = 0; i < allSizeDimension1Length; i++) {
									gap.allSizeDimension1
											.push(window.productPage.arrayAllSizeDimension1[i].strName)
								}

								var allSizeDimension2Length = parseInt(window.productPage.arrayAllSizeDimension2.length);
								for (i = 0; i < allSizeDimension2Length; i++) {
									gap.allSizeDimension2
											.push(window.productPage.arrayAllSizeDimension2[i].strName)
								}
								...
								try {
									...
									for (i = 0; i < arrayTabInfoLength; i++) {
										...
										for (j = 0; j < arrayInfoTabInfoBlocksLength; j++) {
											...
											infoTabs.InfoTabInfoBlocks
													.push(infoTabInfoBlock);
										}
								...
								for (i = 0; i < arrayVariantStyleColorsLength; i++) {
									...
									gap.variantStyleColors
											.push(variantStyleColor);
								}
								...
								for (i = 0; i < arrayVariantStyleColorsLength; i++) {
									...
									case 0:
										for (j = 0; j < gap.allSizeDimension1.length; j++) {
											...
											stock.bStock = Boolean(window.productPage
													.isSkuInStock(i, j, -1,
															undefined));
