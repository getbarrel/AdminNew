...
if($admin_config["selected_templete"]=="") $selected_templete_text=$admin_config[selected_templete_general];
else $selected_templete_text=$admin_config["selected_templete"];
//디자인 페이지 첫 로딩 시 $admin_config["selected_templete"] 정보를 제대로 불러오지 못하는 것 같아서 수정 kbk 13/04/18
...
include("design.common.php");
	...
	// 		}
		...
		if($admin_config[mall_page_type] == "P"){
			...
			$unique_file_path = "templet/".$admin_config[selected_templete]."/".$page_path."/".$page_name; //select 변경 으로 인한 데이터 값 생성 JK 121123
		}else if($admin_config[mall_page_type] == "M"){
			...
			$unique_file_path = "mobile_templet/".$admin_config[selected_templete]."/".$page_path."/".$page_name; //select 변경 으로 인한 데이터 값 생성 JK 121123
		}else if($admin_config[mall_page_type] == "MI"){
			//exit;
			...
			$unique_file_path = "minishop_templet/".$admin_config[selected_templete]."/".$page_path."/".$page_name; //select 변경 으로 인한 데이터 값 생성 JK 121123
		}

		//echo $unique_file_path;
													...
													<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td alt='".$layout->layout."'>" . SelectFileList("layout",$DOCUMENT_ROOT.$templet_path."/layout",$layout->layout)."</td>
		...
		$Contents .="
								...
								<tr>
									...
									".PrintEditPageHistory($unique_file_path)."
									</td>
								</tr>
								</table>
								</div>
		...
		function PrintEditPageHistory($page_name){
			...
			$mString .= "<table cellpadding=0 cellspacing=0 width=100%>
								...
								<td style='text-align:right;'>".page_bar($total, $page, $max,"&".$query_string,"")."</td>
							  </tr>
							  </table>";
		...
		if($admin_config[mall_page_type] == "MI"){
			$db->query("select cname from ".TBL_SHOP_MINISHOP_LAYOUT_INFO." where  cid ='$pcode' ");
		}else{
			$db->query("select cname from ".TBL_SHOP_LAYOUT_INFO." where  cid ='$pcode' ");
		//echo "select cname from ".TBL_SHOP_LAYOUT_INFO." where  cid ='$pcode'"c;
		}
		//echo ("select cname from ".TBL_SHOP_LAYOUT_INFO." where  cid ='$pcode' ");
		$db->fetch();
		...
		if($admin_config[mall_page_type] == "P"){
			$sql = "select * from ".TBL_SHOP_DESIGN." where mall_ix = '".$admininfo[mall_ix]."' and skin_type = '".$admin_config[mall_page_type]."' and pcode ='$pcode' and templet_name = '".$admin_config[selected_templete]."' ";
		}else if($admin_config[mall_page_type] == "M"){
			$sql = "select * from ".TBL_SHOP_DESIGN." where mall_ix = '".$admininfo[mall_ix]."' and skin_type = '".$admin_config[mall_page_type]."' and pcode ='$pcode' and templet_name = '".$admin_config[selected_templete_mobile]."' ";
		}else if($admin_config[mall_page_type] == "MI"){//미니샵
			$sql = "select * from ".TBL_SHOP_DESIGN." where mall_ix = '".$admininfo[mall_ix]."' and skin_type = '".$admin_config[mall_page_type]."' and pcode ='$pcode' and templet_name = '".$admin_config[selected_templete_minishop]."' ";
		}
		//echo $sql;
		$db->query($sql);
		$db->fetch();
				...
				<td align='left' style='vertical-align:top'>
												...
												<table cellpadding=0 cellspacing=0 border=0 width=100% class='input_table_box'>
													...
													<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td>".SelectFileList("layout",$DOCUMENT_ROOT.$templet_path."/layout",$db->dt[layout])."</td>
																	<td style='padding:3px;'>
																	<a href=\"javascript:PopSWindow('design.mod.php?mod=layout&page_name=".$db->dt[layout]."&mmode=pop',980,600,'design')\"'><img src='/admin/images/".$admininfo["language"]."/btn_page_edit.gif'></a>
																	</td>
																</tr>
															</table>
														</td>
													...
													<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td>".SelectFileList("header1",$DOCUMENT_ROOT.$templet_path."/layout/header",$db->dt[header1])."</td>
																	<td style='padding:3px;'>
																	<a href=\"javascript:PopSWindow('design.mod.php?mod=layout/header&page_name=".$db->dt[header1]."&mmode=pop',980,600,'design')\"'><img src='/admin/images/".$admininfo["language"]."/btn_page_edit.gif'></a>
																	</td>
																</tr>
															</table>
														</td>
													...
													<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td>".SelectFileList("header2",$DOCUMENT_ROOT.$templet_path."/layout/header",$db->dt[header2])."</td>
																	<td style='padding:3px;'>
																	<a href=\"javascript:PopSWindow('design.mod.php?mod=layout/header&page_name=".$db->dt[header2]."&mmode=pop',980,600,'design')\"'><img src='/admin/images/".$admininfo["language"]."/btn_page_edit.gif'></a>
																	</td>
																</tr>
															</table>
														</td>
													...
													<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td>".SelectFileList("leftmenu",$DOCUMENT_ROOT.$templet_path."/layout/leftmenu",$db->dt[leftmenu])."</td>
																	<td style='padding:3px;'>
																	<a href=\"javascript:PopSWindow('design.mod.php?mod=layout/leftmenu&page_name=".$db->dt[leftmenu]."&mmode=pop',980,600,'design')\"'><img src='/admin/images/".$admininfo["language"]."/btn_page_edit.gif'></a>
																	</td>
																</tr>
															</table>
														</td>
						...
						$Contents .="			<tr>
													...
													<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td>".SelectFileList("contents_add",$DOCUMENT_ROOT.$templet_path."/layout/contents_add",$db->dt[contents_add])."</td>
																	<td style='padding:3px;'>
																	<a href=\"javascript:PopSWindow('./addfile.pop.php?pcode=".$pcode."&page_path=layout/contents_add',420,170,'fileadd_pop')\"><img src='../images/".$admininfo["language"]."/btn_page_add.gif' border=0 align=absmiddle></a>
																	</td>
																</tr>
						...
						$Contents .="			<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td>".SelectFileList("rightmenu",$DOCUMENT_ROOT.$templet_path."/layout/rightmenu",$db->dt[rightmenu])."</td>
																	<td style='padding:3px;'>
																	<a href=\"javascript:PopSWindow('design.mod.php?mod=layout/rightmenu&page_name=".$db->dt[rightmenu]."&mmode=pop',980,600,'design')\"'><img src='/admin/images/".$admininfo["language"]."/btn_page_edit.gif'></a>
																	</td>
																</tr>
															</table>
														</td>
													...
													<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td>".SelectFileList("footer1",$DOCUMENT_ROOT.$templet_path."/layout/footer",$db->dt[footer1])."</td>
																	<td style='padding:3px;'>
																	<a href=\"javascript:PopSWindow('design.mod.php?mod=layout/footer&page_name=".$db->dt[footer1]."&mmode=pop',980,600,'design')\"'><img src='/admin/images/".$admininfo["language"]."/btn_page_edit.gif'></a>
																	</td>
																</tr>
															</table>
														</td>
													...
													<tr>
														...
														<td class='input_box_item'>
															<table cellpadding=0 cellspacing=0 >
																<tr>
																	<td>".SelectFileList("footer2",$DOCUMENT_ROOT.$templet_path."/layout/footer",$db->dt[footer2])."</td>
																	<td style='padding:3px;'>
																	<a href=\"javascript:PopSWindow('design.mod.php?mod=layout/footer&page_name=".$db->dt[footer2]."&mmode=pop',980,600,'design')\"'><img src='/admin/images/".$admininfo["language"]."/btn_page_edit.gif'></a>
																	</td>
																</tr>
															</table>
														</td>
													...
													<tr>
															...
															<td class='input_box_item'>
															<select name='caching' style='font-size:12px;'>
																<option value='0' ".($db->dt[caching] == "0" ? "selected":"").">캐쉬사용안함</option>
																<option value='1' ".($db->dt[caching] == "1" ? "selected":"").">캐쉬사용</option>
															</select>
															</td>
													</tr>
													<tr>
														...
														<td class='input_box_item'>
															<select name='caching_time' style='font-size:12px;'>
																<option value='0' ".($db->dt[caching_time] == "0" ? "selected":"").">무제한</option>
																<option value='600' ".($db->dt[caching_time] == "600" ? "selected":"").">10분</option>
																<option value='1200' ".($db->dt[caching_time] == "1200" ? "selected":"").">20분</option>
																<option value='1800' ".($db->dt[caching_time] == "1800" ? "selected":"").">30분</option>
																<option value='2400' ".($db->dt[caching_time] == "2400" ? "selected":"").">40분</option>
																<option value='3000' ".($db->dt[caching_time] == "3000" ? "selected":"").">50분</option>
																<option value='3600' ".($db->dt[caching_time] == "3600" ? "selected":"").">60분 (1시간)</option>
																<option value='7200' ".($db->dt[caching_time] == "7200" ? "selected":"").">120분 (2시간)</option>
																<option value='10800' ".($db->dt[caching_time] == "10800" ? "selected":"").">180분 (3시간)</option>
																<option value='14400' ".($db->dt[caching_time] == "14400" ? "selected":"").">240분 (4시간)</option>
																<option value='18000' ".($db->dt[caching_time] == "18000" ? "selected":"").">300분 (5시간)</option>
																<option value='21600' ".($db->dt[caching_time] == "21600" ? "selected":"").">3600분 (6시간)</option>
																<option value='43200' ".($db->dt[caching_time] == "43200" ? "selected":"").">7200분 (12시간)</option>
																<option value='86400' ".($db->dt[caching_time] == "86400" ? "selected":"").">14400분 (24시간)</option>
																<option value='604800' ".($db->dt[caching_time] == "604800" ? "selected":"").">1주일</option>
																<option value='1209600' ".($db->dt[caching_time] == "1209600" ? "selected":"").">2주일</option>
																<option value='1814400' ".($db->dt[caching_time] == "1814400" ? "selected":"").">3주일</option>
																<option value='2419200' ".($db->dt[caching_time] == "2419200" ? "selected":"").">4주일</option>
																<option value='2592000' ".($db->dt[caching_time] == "2592000" ? "selected":"").">1개월</option>
															</select>
														</td>
													</tr>
												</table>
