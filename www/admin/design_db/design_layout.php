	    ...
	    <td align='left' colspan=3  style='vertical-align:top'>
							...
							<tr>
								...
								<table cellpadding=13 cellspacing=4 width=100% bgcolor=#ffffff >
					                		<tr bgcolor=#efefef>
					                			...
					                			<td>".SelectLayoutFileList("layout",$DOCUMENT_ROOT.$templet_path."/layout",$db->dt[layout])."</td>
					                		...
					                		<tr bgcolor=#efefef>
					                			...
					                			<td>".SelectLayoutFileList("header1",$DOCUMENT_ROOT.$templet_path."/layout/header",$db->dt[header1])."</td>
					                		...
					                		<tr bgcolor=#efefef>
					                			...
					                			<td>".SelectLayoutFileList("header2",$DOCUMENT_ROOT.$templet_path."/layout/header",$db->dt[header2])."</td>
					                		...
					                		<tr bgcolor=#efefef>
					                			...
					                			<td>".SelectLayoutFileList("leftmenu",$DOCUMENT_ROOT.$templet_path."/layout/leftmenu",$db->dt[leftmenu])."</td>
				...
				$Contents .="
					                		<tr bgcolor=#efefef>
					                			...
					                			<td>".SelectLayoutFileList("rightmenu",$DOCUMENT_ROOT.$templet_path."/layout/rightmenu",$db->dt[rightmenu])."</td>
					                		...
					                		<tr bgcolor=#efefef>
					                			...
					                			<td>".SelectLayoutFileList("footer1",$DOCUMENT_ROOT.$templet_path."/layout/footer",$db->dt[footer1])."</td>
					                		...
					                		<tr bgcolor=#efefef>
					                			...
					                			<td>".SelectLayoutFileList("footer2",$DOCUMENT_ROOT.$templet_path."/layout/footer",$db->dt[footer2])."</td>
