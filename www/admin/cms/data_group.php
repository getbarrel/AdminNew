...
$Contents01 = "
	<table width='100%' cellpadding=0 cellspacing=0 border='0' align='left'>
	  <tr >
		<td align='left' colspan=6 style='padding-bottom:0px;'> ".GetTitleNavigation("컨텐츠 그룹 관리", "마케팅지원 > 컨텐츠 그룹 관리 ")."</td>
	  </tr>
	  <tr>
			...
			<div class='tab'>
				...
				<tr>
					<td class='tab'>
						...
						<tr>
							<th class='box_01'></th>
							<td class='box_02' onclick=\"document.location.href='image_list.php'\">컨텐츠  관리</td>
							<th class='box_03'></th>
						</tr>
						</table>
						...
						<tr>
							<th class='box_01'></th>
							<td class='box_02' onclick=\"document.location.href='cms_data_group_list.php'\" >컨텐츠 그룹관리</td>
							<th class='box_03'></th>
						</tr>
						</table>
						...
						<tr>
							<th class='box_01'></th>
							<td class='box_02' onclick=\"document.location.href='image_add.php'\">컨텐츠 등록관리</td>
							<th class='box_03'></th>
						</tr>
						</table>
	  ...
	  <table width='100%' cellpadding=0 cellspacing=0 class='input_table_box' style='margin-top:3px;'>
	  <tr >
	  ...
	  <tr>
		...
		<td class='input_box_item'><input type=text class='textbox' name='group_name' value='".$db->dt[group_name]."' style='width:230px;'> <span class=small></span></td>
	  </tr>
	  <tr>
		<td class='input_box_title'> 노출순서 : </td>
		<td class='input_box_item'><input type=text class='textbox' name='vieworder' value='".$db->dt[vieworder]."' style='width:130px;'> <span class=small>노출순서에 의해서 셀렉트 박스 및 리스트 노출순서가 정해집니다</span></td>
	  </tr>
	  <tr >
...
$Contents02 = "
	...
	<table width='100%' cellpadding=0 cellspacing=0 border='0' class='list_table_box' style='margin-top:3px;'>
	  <tr height=25 bgcolor=#efefef align=center style='font-weight:bold'>
	    ...
	    <td class='m_td' style='width:80px;'> 그룹코드</td>
		<td class='m_td' style='width:80px;'> 부모그룹코드</td>
...
$sql = "select abg.* , case when group_depth = 1 then group_ix  else parent_group_ix end as group_order from cms_data_group abg where company_id ='".$admininfo["company_id"]."' order by  group_order asc , group_ix asc, vieworder asc ";
$db->query($sql);
/*
...
if($db->total){
	...
	$Contents02 .= "
		  <tr height=30>
		    ...
		    <td class='list_box_td'>".$db->dt[group_ix]."</td>
			<td class='list_box_td list_bg_gray'>".$db->dt[parent_group_ix]."</td>
...
$Contents = $Contents."<form name='group_form' action='data_group.act.php' method='post' onsubmit='return CheckValue(this)' target=act><input name='mmode' type='hidden' value='$mmode'><input name='act' type='hidden' value='insert'><input name='bm_ix' type='hidden' value='$bm_ix'><input name='group_ix' type='hidden' value=''>";
...
$help_text = "
	<table cellpadding=1 cellspacing=0 class='small' >
		<col width=8>
		<col width=*>
		<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' >컨텐츠 그룹 설정은 <b>2단계</b>까지 가능합니다</td></tr>
	...
	$help_text = HelpBox("컨텐츠 그룹 관리", $help_text);
$Contents = $Contents.$help_text;
 ...
 function CheckValue(frm){
 	...
 	if(frm.group_name.value.length < 1){
 		alert('등록하시고자 하는 컨텐츠 그룹명을 입력해주세요');
...
CREATE TABLE IF NOT EXISTS `cms_data_group` (
  `group_ix` int(4) unsigned NOT NULL auto_increment,
  `parent_group_ix` int(4) unsigned default NULL,
  `group_name` varchar(20) default NULL,
  `group_depth` int(2) unsigned default '1',
