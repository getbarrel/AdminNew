...
<table width='100%' cellpadding=4 cellspacing=0 border='0' >
	  ...
	  <col width=30%>
	  <tr>
	    <td align='left' colspan=0 > ".GetTitleNavigation("사용자 설정", "상점관리 > 사용자 설정 ")."</td>
	  </tr>
	   <tr>
	    ...
	    <div class='tab'>
			...
			<tr>
				...
				<td style='width:450px;text-align:right;vertical-align:bottom;'>
...
$innerview = "
<table class='layer_box' border=0 cellpadding=0 cellspacing=0 style='width:750px;height:0px;display:block;' >
	<col width='11px'>
	<col width='*'>
	<col width='11px'>
	<tr>
...
$inner_inner_view = "
			<h1 id=\"check_title\">".GetTitleNavigation("사용자 설정", "업무관리 관리 > 사용자 설정 ", false)."</h1>
			<form name='edit_form' action='user.act.php' method='post' enctype='multipart/form-data'  onsubmit='return CheckFormUserValue(this)' target='act'>
			...
			<table width='100%' cellpadding=4 cellspacing=0 border='0' >
			  ...
			  <tr bgcolor=#ffffff style='height:24px;'>
				<td style='height:24px;'><img src='../image/ico_dot.gif' align=absmiddle> <b>이름 <img src='".$required_path."'></b></td>
				<td >

					<table cellpadding=0 cellspacing=0>
						<tr>
							<td><input type=text name='name' value='".$db->dt[name]."' class='textbox'  style='width:180px' validation=true title='이름'></td>
				...
				if(file_exists($_SERVER["DOCUMENT_ROOT"].$admin_config[mall_data_root]."/work/profile/profile_".$charger_ix.".jpg")){
					...
					$inner_inner_view .= "<img src='../images/thum_pic4.gif' width=90 height=90>";
				}
$inner_inner_view .= "
				</div></td>
			   </tr>
			  ...
			  <tr bgcolor=#ffffff>
				<td nowrap><img src='../image/ico_dot2.gif' align=absmiddle> 프로파일 이미지  : </td>
				<td >
					<table>
					<tr>
		...
		$inner_inner_view .= "
			  <tr bgcolor=#ffffff >
				<td ><img src='../image/ico_dot.gif' align=absmiddle> <b>부서/직급</b></td>
				<td >
		...
		$inner_inner_view .= "
			  <tr bgcolor=#ffffff  >
				<td ><img src='../image/ico_dot.gif' align=absmiddle> <b>아이디 <img src='".$required_path."'></b>   </td>
				<td colspan=2>
			  ...
			  <tr hegiht=1><td colspan=3 class='dot-x'></td></tr>
			  <tr bgcolor=#ffffff  >
				<td ><img src='../image/ico_dot.gif' align=absmiddle> <b>이메일 <img src='".$required_path."'></b></td>
				<td><input type=text name='mail' value='".$db->dt[mail]."' class='textbox'  style='width:300px;' title='이메일' validation='true' email='true'></td>
			  </tr>
			  <tr hegiht=1><td colspan=3 class='dot-x'></td></tr>
			  <tr bgcolor=#ffffff  >
				<td ><img src='../image/ico_dot.gif' align=absmiddle> <b>핸드폰 <img src='".$required_path."'></b></td>
				<td colspan=2>
			  ...
			  <tr hegiht=1><td colspan=3 class='dot-x'></td></tr>
			  <tr bgcolor=#ffffff  >
				<td ><img src='../image/ico_dot.gif' align=absmiddle> 패스워드</td>
				<td align=left colspan=2 nowrap>
					<table cellpadding=0 cellspacing=0>
					<tr>
						<td><input type=password name='charger_pass' value='' size=12 style='width:150px' class='textbox' ></td>
						<td>".($act == "user_update" ? "<input type=checkbox name=pw value=1> 비밀번호수정":"")."</td>
						<td><div style='display:inline;padding:15px 0px 0px 20px;' class=small>* 비밀번호의 첫문자는 영문으로 시작해야 합니다.</div> </td>
					</tr>
					</table>
			  ...
			  <tr hegiht=1 ><td colspan=3 class='dot-x'></td></tr>
			  <tr bgcolor=#ffffff  >
				<td ><img src='../image/ico_dot.gif' align=absmiddle> 패스워드 확인 </td>
			  ...
			  <tr hegiht=1 ><td colspan=3 class='dot-x'></td></tr>
			  <tr bgcolor=#ffffff  >
				<td ><img src='../image/ico_dot.gif' align=absmiddle> 구글계정 </td>
				<td colspan=2>
				<input type=text name='google_mail' value='".$google_mail."' class='textbox'  style='width:180px' title='구글 이메일' validation='false' email='true'>
				<div style='display:inline;padding:5px;' class=small>* 구글 계정을 입력하시면 <b>구글 캘린더</b>와 일정이 연동됩니다.</div>
				</td>
			  </tr>
			  <tr hegiht=1><td colspan=3 class='dot-x'></td></tr>
			  <tr bgcolor=#ffffff  >
				<td ><img src='../image/ico_dot.gif' align=absmiddle> 구글 패스워드</td>
				<td align=left nowrap><input type=password name='google_pass' value='$google_pass' size=12 style='width:180px' class='textbox' > <div style='display:inline;padding:5px;' class=small>* 비밀번호의 첫문자는 영문으로 시작해야 합니다.</div> </td>
			  </tr>
			  <tr hegiht=1 ><td colspan=3 class='dot-x'></td></tr>
			  <tr bgcolor=#ffffff  >
				<td nowrap><img src='../image/ico_dot.gif' align=absmiddle> 구글 패스워드 확인 </td>
				<td align=left width='30%' nowrap>
			  ...
			  <tr hegiht=1 ><td colspan=3 class='dot-x'></td></tr>
			  <tr bgcolor=#ffffff >
				<td  ><img src='../image/ico_dot.gif' align=absmiddle> 구글 동기화 주기    </td>
				<td colspan=2 >
			  ...
			  <tr bgcolor=#ffffff >
				<td  ><img src='../image/ico_dot.gif' align=absmiddle> 사용자승인    </td>
				<td colspan=2 >
				<select name='charger_auth' style='width:100px;font-size:12px;'>
					<option value='N' ".CompareReturnValue("N",$db->dt[charger_auth],"selected").">승인대기</option>
					<option value='Y'  ".CompareReturnValue("Y",$db->dt[charger_auth],"selected").">승인</option>
					<option value='X' ".CompareReturnValue("X",$db->dt[charger_auth],"selected").">승인거부</option>
...
function deleteUserInfo(company_id, charger_id){

	if(confirm('입점업체 사용자 정보를 정말로 삭제하시겠습니까?')){
		document.frames['act'].location.href='user.act.php?act=user_delete&company_id='+company_id+'&charger_id='+charger_id
	}
}
...
//echo $company_id;
	$mstirng = "
		<table width='100%' cellpadding=0 cellspacing=0 border='0' align='left' class='list_table_box'>
		  <tr height=25 bgcolor=#efefef align=center style='font-weight:bold'>
			...
			<td style='width:180px;' class='m_td' colspan=2> 이름</td>
	...
	if($admininfo[admin_level] == 9){
			$sql = "SELECT cui.*, ui.master , AES_DECRYPT(UNHEX(name),'".$db->ase_encrypt_key."') as name,AES_DECRYPT(UNHEX(mail),'".$db->ase_encrypt_key."') as mail,
					AES_DECRYPT(UNHEX(pcs),'".$db->ase_encrypt_key."') as pcs,AES_DECRYPT(UNHEX(tel),'".$db->ase_encrypt_key."') as tel,
					scp.ps_name
					...
					WHERE  cui.company_id = '".$admininfo[company_id]."'  ";

			$mdb->query($sql);
	}else{
		if(!$company_id){
			$sql = "SELECT cui.*, ui.master , AES_DECRYPT(UNHEX(name),'".$db->ase_encrypt_key."') as name,AES_DECRYPT(UNHEX(mail),'".$db->ase_encrypt_key."') as mail,
					AES_DECRYPT(UNHEX(pcs),'".$db->ase_encrypt_key."') as pcs,AES_DECRYPT(UNHEX(tel),'".$db->ase_encrypt_key."') as tel, scp.ps_name
					FROM ".TBL_COMMON_USER."  cui
					right join ".TBL_COMMON_MEMBER_DETAIL." cmd on cui.code = cmd.code
					right join service_ing si on si.mem_ix = cmd.code and service_div = 'APP' and solution_div = 'WORK' and si_status = 'SI'
					left join work_userinfo ui on cui.code = ui.charger_ix left join shop_company_position scp on cmd.position = scp.ps_ix
					WHERE cui.code = cmd.code and cui.company_id = '".$admininfo[company_id]."'  ";
			//echo $sql;
			$mdb->query($sql);
		}else{
			$sql = "SELECT cui.*, ui.master , AES_DECRYPT(UNHEX(name),'".$db->ase_encrypt_key."') as name,AES_DECRYPT(UNHEX(name),'".$db->ase_encrypt_key."') as name,
					...
					WHERE cui.code = cmd.code and cui.company_id = '".$company_id."' ";
		...
		$mstirng .= "
			  <tr bgcolor=#ffffff height=30 align=center>
				...
				if(file_exists($_SERVER["DOCUMENT_ROOT"].$admin_config[mall_data_root]."/work/profile/profile_".$mdb->dt[code].".jpg")){
					...
					$mstirng .= "<img src='../images/thum_pic4.gif' width=50 height=50>";
				}
		$mstirng .= "
				</td>
				<td class='list_box_td list_bg_gray'' nowrap>".($mdb->dt[master] == "Y" ? "<b>[M]".$mdb->dt[name]."</b>":$mdb->dt[name])."</td>
			    <td class='list_box_td point'>".$mdb->dt[ps_name]."</td>
			    ...
			    <td class='list_box_td list_bg_gray'>
			    	<!-- <a href=\"?company_id=$company_id&charger_id=".$mdb->dt[charger_id]."\"><img src='../image/btc_modify.gif' border=0></a> -->
	...
	$mstirng .="</tabel>";
	$mstirng .="<table width='100%' cellpadding=0 cellspacing=0 border='0'>";
	$mstirng .= "<tr height=1><td colspan=9 style='padding:4px 0px 10px 0px;' align=right><a href=\"javascript:LayerShow('user_input_box')\">
				<img src='../image/btn_admin_add.gif'></a></td></tr>
				</table>";
