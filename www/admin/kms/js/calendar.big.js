...
function ChangeCalendar(LinkPage, vDate, SelectReport){
	vNewdate = vDate;
	//alert(SelectReport);
	if(SelectReport == 1){
		document.location.href=LinkPage+'&vdate='+vDate;	
	//	document.location.href=LinkPage+'?vdate='+vDate+'&SelectReport='+SelectReport
	}else if(SelectReport == 2){
		document.location.href=LinkPage+'&vdate='+printWeek(vDate);
	//	document.location.href=LinkPage+'?vdate='+vDate+'&SelectReport='+SelectReport
...
function ViewReport(LinkPage, vDate){
	...
	if(SelectReport == 1){
		document.location.href=LinkPage+'?list_view_type=calendar&vdate='+vDate+'&SelectReport='+SelectReport;	
	//	document.location.href=LinkPage+'?vdate='+vDate+'&SelectReport='+SelectReport
	}else if(SelectReport == 2){
		document.location.href=LinkPage+'?list_view_type=calendar&vdate='+printWeek(vDate)+'&SelectReport='+SelectReport;
	//	document.location.href=LinkPage+'?vdate='+vDate+'&SelectReport='+SelectReport
	}else if(SelectReport == 3){
		document.location.href=LinkPage+'?list_view_type=calendar&vdate='+vDate+'&SelectReport='+SelectReport;
	//	document.location.href=LinkPage+'?vdate='+vDate+'&SelectReport='+SelectReport
...
function ViewTreeReport(LinkPage, vDate,vName, vreferid,vdepth){
	...
	if(SelectReport == 1){
		//document.location.href=LinkPage+'?vdate='+vDate+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;	
		document.location.href=LinkPage+'?list_view_type=calendar&vdate='+vDate+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;	
	}else if(SelectReport == 2){
		//document.location.href=LinkPage+'?vdate='+vDate+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;
		document.location.href=LinkPage+'?list_view_type=calendar&vdate='+printWeek(vDate)+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;
	}else if(SelectReport == 3){
		document.location.href=LinkPage+'?list_view_type=calendar&vdate='+vDate+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;
	//	document.location.href=LinkPage+'?vdate='+vDate+'&SelectReport='+SelectReport
	}
...
function ChangeCalenderView(vSelectReport){
	...
	if(vSelectReport == 1){
		...
		document.location.href='?list_view_type=calendar&vdate='+vDate+'&SelectReport='+vSelectReport;
		/*
		try{
			for(seq = 0; seq < 6; seq++){
				oTD = eval('document.all.week' + seq);
