...
/*	Create Root node	*/
	var rootnode = new TreeNode('내지식카테고리', '../resources/ServerMag_Etc_Root.gif','../resources/ServerMag_Etc_Root.gif');
	rootnode.action = \"setCategory('product category','000000000000000',-1,'".$id."')\";
	rootnode.expanded = true;";

$mdb->query("SELECT * FROM kms_mycategory where uid = '".$admininfo[charger_ix]."' order by vlevel1, vlevel2, vlevel3, vlevel4, vlevel5");
