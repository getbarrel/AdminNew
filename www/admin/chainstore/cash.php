...
function DeleteCash(c_ix, company_id){
	if(confirm(language_data['cash.php']['A'][language])){//적립금 정보를 정말로 삭제하시겠습니까?
		document.frames['iframe_act'].location.href='cash.act.php?act=cash_delete&c_ix='+c_ix+'&company_id='+company_id;
	}
}
							...
							<td class='box_05' align=right style='padding:0px'>
								<table border='0' width='100%' cellspacing='0' cellpadding='0' class='search_table_box'>
									...
									<tr height='30' align='center'>
										...
										<td class='list_bg_gray'>	<input type='image' src='../images/".$admininfo["language"]."/btn_s_ok.gif' align=absmiddle> <a href='javascript:CashReset();'><img src='../images/".$admininfo["language"]."/btn_s_cancle.gif' align=absmiddle border=0></a></td>
									</tr>
								</table>
							</td>
							<th class='box_06'></th>
