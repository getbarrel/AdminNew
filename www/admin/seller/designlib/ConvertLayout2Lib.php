...
function ConvertLayout2()
{
	...
	$skin_type = "MI";
	$templet_name =$admin_config["selected_templete_minishop"];
	...
	for($i=0;$i < count($results);$i++){
		$row = $results[$i];
 		...
 		$layout->addChild("vlevelf", sprintf("%03d%03d%03d%03d%03d", $row["vlevel1"], $row["vlevel2"], $row["vlevel4"], $row["vlevel5"]));
