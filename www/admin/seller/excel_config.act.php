...
if($act == "seller_user_list"){	//셀러기존용
	$conf_name="seller_".$info_type;
	$conf_name_check="seller_checked_".$info_type;

}else if($act == "seller_list_excel"){	//셀러기존용
...
if($act == "delete_setting" ){
	...
	$sql = "delete from inventory_config where charger_ix='".$admininfo[charger_ix]."' and conf_name='seller_user_excel_".$info_type."'   ";
	//echo $sql;
	$db->query($sql);
