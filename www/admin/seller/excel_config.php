...
if($excel_type == "seller_user_excel"){
	$excel_name = "셀러 사용자 리스트 ";
	$act = "seller_user_list";
...
}else if($excel_type == "stock_report_excel"){
...
if($db->dt[conf_val] && $stock_report_excel && false){
