...
$P->strContents = print_bbs("b2b_notice",$mode,$act,NULL,true) ; //$msb->PrintMsBoardList();
}else{
$P->strContents = print_bbs("b2b_notice",$mode,$act,NULL,false) ; //$msb->PrintMsBoardList();
}
$P->Navigation = "셀러관리 > 입점업체 공지";
$P->title = "입점업체 공지";
