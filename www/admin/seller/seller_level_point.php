...
function CheckDelete(frm){
	if(confirm('선택하신 판매신용점수를 정말로 삭제하시겠습니까? 삭제하신 판매신용점수은 복원되지 않습니다')){
		for(i=0;i < frm.reserve_id.length;i++){
			...
			<tr>
				<td class='box_05' valign=top style='padding:0px;'>
					...
					<tr>
						...
						<span style='position:relative;top:1px;' >검색어</span>
						<span style='padding-left:2px;' class='helpcloud' help_width='220' help_height='30' help_html='검색하시고자 하는 값을 ,(콤마) 구분으로 넣어서 검색 하실 수 있습니다'>
							<img src='/admin/images/icon_q.gif' style='position:relative;top:3px;' />
						</span>
					...
					<tr height=27>
						<td class='search_box_title' bgcolor='#efefef' align=center>
							...
							<!--select name='search_state_type'>
								<option value='state_4' ".CompareReturnValue("ccd.com_ceo",$search_type).">적립일</option>
...
$Contents01 .= "
	...
	<form name=reserve_list method=post action='seller_penalty.act.php' onsubmit='return CheckDelete(this)' target='iframe_act'>
	...
	<tr bgcolor=#efefef style='font-weight:bold' align=center height=33>
		...
		<td class='m_td small' ><b>판매신용<br>점수구분</b></td>
...
$Contents01 .= "<font>
				...
				<td class='list_box_td' style='padding:3px;'>
					<a href=\"javascript:PoPWindow('seller_penalty.pop.php?company_id=".$data_array[$i][company_id]."',800,550,'penalty_pop')\">
...
$Contents01 .= "
			<tr height=60><td class='list_box_td' colspan=10 align=center>셀러 판매신용점수 내역이 존재하지 않습니다.</td></tr>";
}
...
$Contents01 .= "
		...
		if(checkMenuAuth(md5($_SERVER["PHP_SELF"]),"D")){
			$Contents01 .= "<td align=left></td>";//<a href=\"JavaScript:SelectDelete(document.forms['reserve_list']);\"><img  src='../images/".$admininfo["language"]."/bt_all_del.gif' border=0 align=absmiddle ></a>
		}else{
			$Contents01 .= "<td align=left></td>";//<a href=\"".$auth_delete_msg."\"><img  src='../images/".$admininfo["language"]."/bt_all_del.gif' border=0 align=absmiddle ></a>
		}
		$Contents01 .= "
...
$Contents .= HelpBox("셀러 판매신용점수 관리", $help_text);

$P = new LayOut();
$P->addScript = "<script language='javascript' src='../include/DateSelect.js'></script>\n".$Script;
$P->OnloadFunction = "";
$P->strLeftMenu = seller_menu();
$P->Navigation = "셀러관리 > 셀러 판매신용점수 관리";
$P->title = "셀러 판매신용점수 관리";
