...
function Content_Input(){		
	document.info_input.content.value = document.info_input.mall_useinfo.value;			
}

</Script>
";

$templet_path = $_SERVER["DOCUMENT_ROOT"]."".$admin_config[mall_data_root]."/templet/".$admin_config[mall_use_templete];
$thisfile = load_template($templet_path."/ms_useinfo.htm");
/*
$db = new Database;
...
$Contents ="
			...
			<form name=info_input action='useinfo.act.php' method='post' onsubmit='return SubmitX(this);'>
			<input type='hidden' name=act value='update'>
			<input type='hidden' name=mall_ix value='".$admininfo[company_id]."'>			
                    <tr><td colspan=3 align=right style='padding-bottom:10px;'>".colorCirCleBox("#efefef","100%","<div style='padding:5px;'><img src='../image/title_head.gif' align=absmiddle><b> 이용안내  관리</b></div>")."</td></tr>
...
<textarea name='mall_useinfo'  style='display:none'>".$thisfile."</textarea></form>
                  ";
