...
function Content_Input(){	
	document.info_input.content.value = document.info_input.mall_raw2.value;		
}
...
$db->query("select mall_raw2 from ".TBL_SHOP_SHOPINFO." where mall_ix = '".$admininfo[company_id]."'");
$db->fetch();
$Contents ="
			<table width='100%' border='0' cellspacing='0' cellpadding='0' height='25'>
			<form name=info_input action='privacyintro.act.php' method='post' onsubmit='return SubmitX(this);'>
			<input type='hidden' name=act value='update'>
			<input type='hidden' name=mall_ix value='".$admininfo[company_id]."'>			
                    <tr><td colspan=3 align=right style='padding:10px;'>".colorCirCleBox("#efefef","100%","<div style='padding:5px;'><img src='../image/title_head.gif' align=absmiddle><b> 개인보호 정책 관리</b></div>")."</td></tr>
...
<textarea name='mall_raw2'  style='display:none'>".$db->dt[mall_raw2]."</textarea></form>
                  ";
