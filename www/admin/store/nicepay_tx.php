...
$db->query("SELECT * FROM shop_payment_config where pg_code = 'nicepay_tx' and mall_ix = '".$mall_ix."' "); //and mall_ix = '".$admininfo[mall_ix]."'
...
$Contents = $Contents."<form name='edit_form' action='nicepay_tx.act.php' method='post' onsubmit='return validate(document.edit_form)' target='act'>
