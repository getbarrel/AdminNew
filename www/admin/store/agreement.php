...
function Content_Input(){	
	document.info_input.content.value = document.info_input.mall_raw1.value;		
}
...
$Contents ="
			...
			<form name=info_input action='agreement.act.php' method='post' onsubmit='return SubmitX(this);'>
			<input type='hidden' name=act value='update'>
			<input type='hidden' name=mall_ix value='".$admininfo[company_id]."'>	
					
                    <tr><td colspan=3 align=right style='padding:10px;'>".colorCirCleBox("#efefef","100%","<div style='padding:5px;'><img src='../image/title_head.gif' align=absmiddle><b> 이용약관</b></div>")."</td></tr>
...
<textarea name='mall_raw1'  style='display:none'>".$db->dt[mall_raw1]."</textarea></form>
                  ";
...
$LO->title = "<b style='color:#ffffff;font-size:12px;'> ♣ 이용약관 관리 </b>";
