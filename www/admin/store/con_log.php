...
$mstring ="
		...
		<tr>
			<td align='left' colspan=6 > ".GetTitleNavigation("접속로그", "사이트관리 > 접속로그 ")."</td>
		</tr>
		<tr>
...
$help_text = "<div style='position:relative;z-index:100px;'>".HelpBox("<div style='position:relative;top:4px;'><table><tr><td valign=bottom><b>접속 로그</b></td><td></td></tr></table></div>", $help_text,170)."</div>";
