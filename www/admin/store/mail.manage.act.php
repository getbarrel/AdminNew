...
if ($act == "insert"){
	...
	$sql = "insert into ".TBL_SHOP_MAILSEND_CONFIG." 
		    (mc_ix,mc_code,mc_title,mc_mail_title,mc_mail_text,mc_sms_text, mc_mail_usersend_yn,mc_mail_adminsend_yn,mc_sms_usersend_yn,mc_sms_adminsend_yn, disp,regdate) 
		    values
		    ('$mc_ix','$mc_code','$mc_title','$mc_mail_title','$mc_mail_text','$mc_sms_text','$mc_mail_usersend_yn','$mc_mail_adminsend_yn','$mc_sms_usersend_yn','$mc_sms_adminsend_yn','$disp',NOW())";
	//echo $sql;
...
//	echo $content;
	...
	echo("<script>location.href = 'mail.manage.list.php';</script>");
}
...
if ($act == "update"){
	...
	$sql = "update ".TBL_SHOP_MAILSEND_CONFIG." set 
		    mc_code='$mc_code',mc_title='$mc_title',mc_mail_title='$mc_mail_title',mc_mail_text='$mc_mail_text',mc_sms_text='$mc_sms_text',mc_mail_usersend_yn='$mc_mail_usersend_yn',mc_mail_adminsend_yn='$mc_mail_adminsend_yn',mc_sms_usersend_yn='$mc_sms_usersend_yn',mc_sms_adminsend_yn='$mc_sms_adminsend_yn',disp='$disp',regdate=NOW() 
		    where mc_ix='$mc_ix' ";
