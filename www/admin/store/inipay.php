...
$db->query("SELECT * FROM shop_payment_config where pg_code = 'inipay' and mall_ix = '".$mall_ix."' "); //and mall_ix = '".$admininfo[mall_ix]."'
...
$Contents01 = "<table width='100%' cellpadding=3 cellspacing=0 border='0' align='left'  >
	...
	<table width='100%' cellpadding=3 cellspacing=0 border='0' align='left' class='input_table_box'>
	  ...
	  <tr bgcolor=#ffffff >
	    <td class='input_box_title'> INIPay Key File mcert.pem</td>
		<td class='input_box_item'><input type=file  name='inipay_file1' value='' style='width:230px;'> <span class=small><b>mcert.pem</b> 파일을 입력해주세요</span></td>
	  </tr>
	  <tr bgcolor=#ffffff >
	    <td class='input_box_title'> INIPay Key File mpriv.pem</td>
		<td class='input_box_item'><input type=file  name='inipay_file2' value='' style='width:230px;'> <span class=small><b>mpriv.pem</b> 파일을 입력해주세요</span></td>
	  </tr>
	  <tr bgcolor=#ffffff >
	    <td class='input_box_title'> INIPay Key File keypass.enc</td>
		<td class='input_box_item'><input type=file  name='inipay_file3' value='' style='width:230px;'> <span class=small><b>keypass.enc</b> 파일을 입력해주세요</span></td>
	  </tr>
...
$Contents = $Contents."<form name='edit_form' action='inipay.act.php' method='post' onsubmit='return validate(document.edit_form)' target='act'><input name='act' type='hidden' value='update'><input name='mall_ix' type='hidden' value='".$payment_config[mall_ix]."'>";
...
$P->Navigation = "HOME > 상점관리 > 결제모듈(이니시스)";
$P->title = "결제모듈(이니시스)";
