...
$db->query("SELECT * FROM shop_payment_config where pg_code = 'inicis_unionpay' and mall_ix = '".$mall_ix."' "); //and mall_ix = '".$admininfo[mall_ix]."'
...
$Contents01 = "<table width='100%' cellpadding=3 cellspacing=0 border='0' align='left'  >
	...
	<table width='100%' cellpadding=3 cellspacing=0 border='0' align='left' class='input_table_box'>
	  ...
	  <tr bgcolor=#ffffff >
	    <td style='width:150px;' class='input_box_title'> inicis_unionpay ID </td>
	  ...
	  <tr bgcolor=#ffffff >
	    <td style='width:150px;' class='input_box_title'> inicis_unionpay signkey </td>
...
$Contents = $Contents."<form name='edit_form' action='inicis_unionpay.act.php' method='post' onsubmit='return validate(document.edit_form)' target='act'><input name='act' type='hidden' value='update'>";
...
$P->Navigation = "HOME > 상점관리 > 결제모듈(이니시스_유니온페이)";
$P->title = "결제모듈(이니시스_유니온페이)";
