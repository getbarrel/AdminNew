...
if($cid){
	...
	$sql = "SELECT cid, cname FROM shop_category_info where  depth ='".($depth+1)."' and cid LIKE '".substr($cid,0,($depth+1)*3)."%' and category_type = 'C' and category_use != '0'  order by vlevel1, vlevel2, vlevel3, vlevel4, vlevel5 ";
	echo $sql;
	$db->query($sql);
}else{
