...
$db = new Database;
if($cid){
	$db->query("SELECT cid, cname FROM ".$tb." where depth ='".($depth+1)."' and cid LIKE '".substr($cid,0,($depth+1)*3)."%' ".$minishopWhere." order by vlevel1, vlevel2, vlevel3, vlevel4, vlevel5 ");
}else{
	if($return_type != "json"){
