...
$db->query("select download_desc from shop_product where id = '$id' ");
$db->fetch();
...
$filepath = $_SERVER["DOCUMENT_ROOT"]."".$admin_config[mall_data_root]."/images/product".$uploaddir."/download/".$down_dir."/".iconv("utf-8","CP949",$db->dt[download_desc]);

$filepath = addslashes($filepath);
$original = $db->dt[download_desc];
//echo $filepath;
