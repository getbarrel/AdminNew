...
$Contents02 = "
	<table width='100%' cellpadding=0 cellspacing=0 border='0' align='left'>
	  <tr >
			<td align='left' colspan=9 style='padding-bottom:10px;'> ".GetTitleNavigation("이미지 리사이징", "상품관리 > 이미지 리사이징 ")."</td>
	  </tr>
	<tr>
...
$sql = "select * from shop_image_resizeinfo order by idx";
$db->query($sql);
/*
$image_infos[1] = "확대이미지";
$image_infos[2] = "상세이미지";
...
*/
$image_infos[1] = "리스트이미지";
$image_infos[2] = "마우스오버이미지";
$image_infos[3] = "리스트작은이미지";
$image_infos[4] = "썸네일이미지";
$image_infos[5] = "패턴이미지";
...
$Contents .= HelpBox("이미지 리사이징", "사이즈 정보 수정 후 등록한 상품 이미지부터 리사이징이 적용됩니다. 이전에 등록한 상품 이미지는 자동 적용되지 않습니다");

 $Script = "
 <script language='javascript'>

	 function deleteBanner(act, banner_ix){
		if(confirm(language_data['product_resize.php']['A'][language])){//'배너를 정말로 삭제하시겠습니까?'
...
$P->addScript = $Script;
$P->Navigation = "HOME > 상품관리 > 이미지 리사이징";
$P->NaviTitle = "이미지 리사이징";
