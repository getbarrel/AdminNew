...
if($parent_cd_ix){
	...
	echo "<script type='text/javascript'>
		...
		if(parent.document.forms['$form'].elements['bd_ix2']) parent.document.forms['$form'].elements['bd_ix2'].value = '".$parent_cd_ix."';//추가 kbk 13/07/01
	</script>";
	exit;
}
      ...
      //}
        ...
        for($i=0; $i < $db->total; $i++){
				...
				echo "<script type='text/javascript'>
					...
					parent.document.forms['$form'].elements['".$target."'].options[".($i+1)."].value = '".$db->dt[cd_ix]."';
				</script>";
        }
		exit;
