...
if($act == "insert"){
	...
	//MO Icon
	if ($_FILES["mo_icon_file"]["size"] > 0){
		move_uploaded_file($_FILES["mo_icon_file"]["tmp_name"], $_SERVER["DOCUMENT_ROOT"]."".$_SESSION["admin_config"][mall_data_root]."/images/icon/mo_".$idx.".gif");
		$db->query("update shop_icon set mo_idx = 'mo_".$idx."' where idx = '$idx' ");
	}
