...
<script>
	...
	rootnode.action = \"setCategory('분류','000000000000000',-1,'','','calss','','')\";
	rootnode.expanded = true;
";

$db->query("SELECT * FROM shop_laundry_info where depth in(0,1,2,3,4) order by vlevel1, vlevel2, vlevel3, vlevel4, vlevel5");
...
<script language='JavaScript' src='laundry.js'></script>
							...
							<div id=TREE_BAR >
								...
								<tr>
									<td style='padding-left:10px;padding-top:5px;padding-bottom:3px;' valign=middle nowrap>
										<form name='laundry_order' method='get' action='laundryorder.php' target='calcufrm'>
										<input type='hidden' name='this_depth' value=''>
										<input type='hidden' name='cid' value=''>
										<input type='hidden' name='mode' value=''>
										<input type='hidden' name='view' value=''><!--innerview-->
										<img src='../image/t.gif' onclick='order_up(document.laundry_order)' style='cursor:hand' alt='분류 위로 이동' align=absmiddle>
										<img src='../image/b.gif' onclick='order_down(document.laundry_order)' style='cur sor:hand' alt='분류 아래로 이동' align=absmiddle>
										</td>
...
$Contents .= "
				...
				<form name='thisCategoryform' method=\"post\" action='laundry.save.php' target='calcufrm' style='display:inline;'><!--target='calcufrm'-->
				...
				<tr bgcolor=#ffffff>
					<td class='input_box_title' nowrap oncontextmenu='init2();return false;'> 	<b>분류명_국문 <img src='".$required3_path."'></b></td>
					...
					<td class='input_box_title' nowrap oncontextmenu='init2();return false;'> 	<b>분류명_영문 <img src='".$required3_path."'></b></td>
					<td class='input_box_item' nowrap >
						<input type='text' class='textbox' name='title_en' id='title_en' maxlength=40 validation=true title='분류명_영문'>
					</td>
				</tr>
				<tr>
					<td class='input_box_title' nowrap oncontextmenu='init2();return false;'><b>분류사용_국문 <img src='".$required3_path."'></b></td>
					<td class='input_box_item' nowrap style='padding:5px;'>
						<input type='radio' name='laundry_use' id='laundry_use_id' value=1 checked /><label for='laundry_use_id'> 사용</label>&nbsp;
						<input type='radio' name='laundry_use' id='laundry_use_id_0' value=0 /><label for='laundry_use_id_0'> 미사용</label>&nbsp;
					</td>
					<td class='input_box_title' nowrap oncontextmenu='init2();return false;'><b>분류사용_영문 <img src='".$required3_path."'></b></td>
					<td class='input_box_item' nowrap style='padding:5px;'>
						<input type='radio' name='laundry_use_en' id='laundry_use_en_id' value=1 checked /><label for='laundry_use_en_id'> 사용</label>&nbsp;
						<input type='radio' name='laundry_use_en' id='laundry_use_en_id_0' value=0 /><label for='laundry_use_en_id_0'> 미사용</label>&nbsp;
					</td>
				</tr>
				...
				<col width='*'>
				<tr>
					<td class='input_box_title'> 	<b>설명_국문 </b></td>
					<td height='100px'>
					    <textarea name='contents' style='width:97.5%;height:80px;'></textarea>
					</td>
				</tr>
				<tr>
					<td class='input_box_title'> 	<b>설명_영문 </b></td>
					<td height='100px'>
					    <textarea name='contents_en' style='width:97.5%;height:80px;'></textarea>
					</td>
				</tr>
...
$Contents .= "
				...
				<form name='subCategoryform' method=\"post\" action='laundry.save.php' target='calcufrm' style='display:inline;'>
				...
				<tr >
					<td class='input_box_title' nowrap>  <b>분류명_국문 <img src='".$required3_path."'></b></td>
					<td class='input_box_item'>
						<input type='text' class='textbox' name='title' maxlength=40 validation=true title='분류명_국문'>
					</td>
					<td class='input_box_title' nowrap>  <b>분류명_영문 <img src='".$required3_path."'></b></td>
					<td class='input_box_item'>
						<input type='text' class='textbox' name='title_en' maxlength=40 validation=true title='분류명_영문'>
					</td>
				</tr>
				<tr>
					<td class='input_box_title' nowrap oncontextmenu='init2();return false;'><b>분류사용_국문 <img src='".$required3_path."'></b></td>
					<td class='input_box_item' nowrap style='padding:5px;'>
						<input type='radio' name='laundry_use' id='laundry_use_id' value=1 checked><label for='category_use_id_'> 사용</label>&nbsp;
						<input type='radio' name='laundry_use' id='laundry_use_id_0' value=0 ><label for='category_use_id_10'> 미사용</label>&nbsp;
					</td>
					<td class='input_box_title' nowrap oncontextmenu='init2();return false;'><b>분류사용_영문 <img src='".$required3_path."'></b></td>
					<td class='input_box_item' nowrap style='padding:5px;'>
						<input type='radio' name='laundry_use_en' id='laundry_use_en_id' value=1 checked><label for='category_use_id_'> 사용</label>&nbsp;
						<input type='radio' name='laundry_use_en' id='laundry_use_en_id_0' value=0 ><label for='category_use_id_10'> 미사용</label>&nbsp;
					</td>
				</tr>
				</table>";
			...
			<table cellpadding=0 cellspacing=0 border=0 bgcolor=#e2e2e2 style='border:3px solid #d8d8d8'>
				<tr>
					<td style='padding-left:10px;padding-top:5px;padding-bottom:3px;' valign=middle>
						...
						<input type='hidden' name='view' value='innerview'>
						<!-- <img src='../image/t.gif' onclick='order_up(document.laundry_order)' style='cursor:hand' alt='분류 위로 이동' align=absmiddle>
						<img src='../image/b.gif' onclick='order_down(document.laundry_order)' style='cursor:hand' alt='분류 아래로 이동' align=absmiddle> -->
...
$P->strContents = $Contents;
$P->Navigation = "상품관리 > 상품분류관리 > 세탁주의관리";
$P->title = "세탁주의관리";
$P->PrintLayOut();
}
...
function PrintNode($mdb){
	...
	$title			= $mdb->dt[title];
	$contents		= $mdb->dt[contents];
	$laundry_use	= $mdb->dt[laundry_use];
	$title_en		= $mdb->dt[title_en];
	$contents_en	= $mdb->dt[contents_en];
	$laundry_use_en = $mdb->dt[laundry_use_en];
	$cid			= $mdb->dt[cid];
	$depth			= $mdb->dt[depth];
	...
	$contents_en = str_replace("\"","&quot;",$contents_en);
	$contents_en = str_replace("'","&#39;",$contents_en);
	...
	node$cid.action = \"setCategory('$title','$cid', $depth, '$laundry_use', '$laundry_use_en', '$title_en', '$contents', '$contents_en')\";
...
function PrintGroupNode($mdb)
{
	...
	$mstring .=  "	groupnode$mcid.tooltip = '$title';
		...
		groupnode$mcid.action = \"setCategory('$title', '$mcid', $depth, '$laundry_use', '$laundry_use_en', '$title_en', '$contents', '$contents_en')\";
