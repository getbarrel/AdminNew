...
if ($act == "insert")
{
	...
	$sql = "insert into shop_company_div (cd_ix,parent_cd_ix , div_name,depth, vieworder, disp,regdate) 
			values
			('','$parent_cd_ix','$div_name','$depth','$vieworder','$disp',NOW())";
	$db->query($sql);
	$cd_ix = $db->insert_id();

	$path = $_SERVER["DOCUMENT_ROOT"]."".$admin_config[mall_data_root]."/images/company_div/";
	...
	$path = $_SERVER["DOCUMENT_ROOT"]."".$admin_config[mall_data_root]."/images/company_div/$cd_ix/";
	...
	{
		copy($_FILES["brand_div_img"]["tmp_name"], $_SERVER["DOCUMENT_ROOT"]."".$admin_config[mall_data_root]."/images/company_div/".$cd_ix."/company_div_".$cd_ix.".gif");
	}
...
if ($act == "update"){
	...
	$sql = "update shop_company_div set div_name='$div_name',vieworder='$vieworder',disp='$disp' where cd_ix='$cd_ix'  ";
...
{
	if ($imagetype == "company_div"){
		unlink($_SERVER["DOCUMENT_ROOT"]."".$admin_config[mall_data_root]."/images/company_div/".$cd_ix."/company_div_".$cd_ix.".gif");
	}
...
if ($act == "delete"){
	...
	$sql = "delete from shop_company_div where cd_ix='$cd_ix'";
	$db->query($sql);
