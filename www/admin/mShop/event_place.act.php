...
if($act == "update"){
	...
	o2oSendPush('P',$_POST["place_ix"],"U");
...
if($act == "insert"){
	...
	$sql = "insert into shop_event_place
				(place_ix,place_name,place_zip,place_addr1,place_addr2,place_radius,place_latitude,place_longitude,editdate,regdate)
				values
				('','".$_POST["place_name"]."','".$_POST["place_zip"]."','".$_POST["place_addr1"]."','".$_POST["place_addr2"]."','".$_POST["place_radius"]."','".$_POST["place_latitude"]."','".$_POST["place_longitude"]."',NOW(),NOW())";

	$db->query($sql);
	$place_ix = $db->insert_id();

	o2oSendPush('P',$place_ix,"I");
