...
<tr>
	<td>
		<table width="650" border="0" cellpadding="3" cellspacing="0" bgcolor="#666666">
			...
			<tr bgcolor="#FFFFFF"> 
				<td colspan="3" class="b r l">견적금액 : &nbsp;&nbsp;&nbsp;&nbsp;<strong>\<?=number_format($estimate_totalprice)?></strong>&nbsp;&nbsp;&nbsp;&nbsp;( <strong><?=price_trans($estimate_totalprice)?></strong> 원정 )</td>
...
<tr>
	<td>
		<table width="650" border="0" cellpadding="3" cellspacing="0" bgcolor="#666666" id='estimate2'>
		<tr bgcolor="#FFFFFF"> 
