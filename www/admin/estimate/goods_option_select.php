								...
								<tr height="34" >
									...
									<td style="width:68px;">
										<ul class="option_up_down" style="float:left;">
											...
											<input type="text" name="order_lists[0][amount]" minicart_id="amount" value="'.$cart_option[pcount].'" allow_basic_cnt="'.$cart_option[allow_basic_cnt].'" size=4 maxlength=3 onkeydown="onlyEditableNumber(this)" onkeyup="onlyEditableNumber(this);" style="margin:0px 2px;" min_amount="'.$cart_option[allow_basic_cnt].'" max_amount="'.$cart_option[allow_byoneperson_cnt].'"/>
								...
								<tr height="34" >
									...
									<td style="width:78px;">
										<ul class="option_up_down" style="float:left;">
											...
											<input type="text" name="order_lists[0][amount]" minicart_id="amount" value="1" allow_basic_cnt="'.$cart_option[allow_basic_cnt].'" min_amount="'.$cart_option[allow_basic_cnt].'" max_amount="'.$cart_option[allow_byoneperson_cnt].'" size=4 maxlength=3 onkeydown="onlyEditableNumber(this)" onkeyup="onlyEditableNumber(this);" style="margin:0px 2px;" />
											</li>
											<li style="border:1px solid #c2c2c2;line-height:0;font-size:0;float:left;">
												<img src="/data/daiso_data/templet/daiso/images/up_arrow.gif" alt="" onclick="minicart_pcount_cnt($(this), \'p\');" />
											</li>
