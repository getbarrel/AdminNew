...
if($est_ix){
	...
	$sql = "select
			...
			from
					...
					inner join common_user as cu on (o.uid = cu.code)
...
$Contents01 .= "
	  ...
	  <tr>
		...
		<td class='input_box_item'><input type=text  id='open_date' name='open_date' value='".$open_date[0]."' class='textbox'  style='width:200px' validation='false' title='견적의뢰일자'></td>
	  </tr>
	  	<tr height='30' id='move_status_tr'>
			...
			<td class='input_box_item'>
				...
				<input type=radio name='estimate_type' id='estimate_type_2' value='2' ".($db->dt[estimate_type] == '2' || $db->dt[estimate_type] == ''?"checked":"")."><label for='estimate_type_2'>선택 견적서</label>
				<input type=radio name='estimate_type' id='estimate_type_3' value='3' ".($db->dt[estimate_type] == '3'?"checked":"")."><label for='estimate_type_3'>전문가 견적서</label>
		...
		<tr height='30' id='move_status_tr'>
			...
			<td class='input_box_item' colspan=3>
				<input type=radio name='estimate_div' id='estimate_div_1' value='1' ".($db->dt[estimate_div] == '1' || $db->dt[estimate_div] == ''?"checked":"")."><label for='estimate_div_1'>창업문의</label>
				<input type=radio name='estimate_div' id='estimate_div_2' value='2' ".($db->dt[estimate_div] == '2'?"checked":"")."><label for='estimate_div_2'>대량구매문의</label>
			</td>
		</tr>";
...
$Contents01 .= "
		<tr>
			...
			<td class='input_box_item'>
				<input type='text' name='btel_1' id='tel1_a' size='10' maxlength='3' class='textbox' value='".$tel[0]."' validation='false' title='전화번호' numeric='true'> -
				<input type='text' name='btel_2' id='tel2_a' size='12' maxlength='4' class='textbox' value='".$tel[1]."' validation='false' title='전화번호' numeric='true'> -
				<input type='text' name='btel_3' id='tel3_a' size='12' maxlength='4' class='textbox' value='".$tel[2]."' validation='false' title='전화번호' numeric='true'>
			</td>
		</tr>
		<tr>
			<td class='list input_box_title'>의뢰인 핸드폰</td>
			<td class='input_box_item'>
				<input type='text' name='bmobile_1' id='pcs1_a' size='10' maxlength='3' class='textbox' value='".$mobile[0]."' validation='true' title='핸드폰번호' numeric='true'> -
				<input type='text' name='bmobile_2' id='pcs2_a' size='12' maxlength='4' class='textbox' value='".$mobile[1]."' validation='true' title='핸드폰번호' numeric='true'> -
				<input type='text' name='bmobile_3' id='pcs3_a' size='12' maxlength='4' class='textbox' value='".$mobile[2]."' validation='true' title='핸드폰번호' numeric='true'></td>
			<td class='input_box_title'> <b>견적만료일</b>   </td>
			<td class='input_box_item'><input type=text  id='plan_date' name='plan_date' value='".$plan_date[0]."' class='textbox'  style='width:200px' validation='false' title='견적만료일'></td>
		</tr>
		<tr>
			<td class='list input_box_title'>주문자 주소</td>
			<td class='input_box_item'style='padding:5px 5px;' colspan=3>
			<input type='text' name='zipcode1' class='textbox' id='zipcode1'  size='10' maxlength='3' class='textbox' value='".$bzip[0]."' validation='true' title='우편번호' >		-
			<input type='text' name='zipcode2' class='textbox' id='zipcode2'  size='10' maxlength='3' class='textbox' value='".$bzip[1]."' validation='true' title='우편번호' >
			...
			<input type='text' name='addr1' id='addr1' size='80' maxlength='80' class='textbox' style='margin-top:3px; margin-bottom:3px;' value='".$db->dt[baddr1]."' validation='true' title='주소' ><br />
			<input type='text' name='addr2' id='addr2' size='80' maxlength='80' class='textbox' value='".$db->dt[baddr2]."' validation='true' title='세부주소'> 세부주소</td>
		</tr>
		<tr>
...
$Contents01 .= "
	...
	<tr class='br'>
		...
		<td class='input_box_item'>
			<input type=text name='com_number_1' id='com_number_1' value='".$com_number[0]."' maxlength=3 size=5  class='textbox' com_numeric=true validation='false' title='사업자번호'> -
			<input type=text name='com_number_2' id='com_number_2' value='".$com_number[1]."' maxlength=2 size=5 class='textbox' com_numeric=true validation='false' title='사업자번호'> -
			<input type=text name='com_number_3' id='com_number_3' value='".$com_number[2]."' maxlength=5 size=5 class='textbox' com_numeric=true validation='false' title='사업자번호'>
	  ...
	  <tr>
		...
		<td class='input_box_item'>
			<input type=text name='com_phone_1' id='com_phone_1' value='".$com_phone[0]."' maxlength=4 size=4  class='textbox' com_numeric=true validation='false' title='대표번호'> -
			<input type=text name='com_phone_2' id='com_phone_2' value='".$com_phone[1]."' maxlength=4 size=4 class='textbox' com_numeric=true validation='false' title='대표번호'> -
			<input type=text name='com_phone_3' id='com_phone_3' value='".$com_phone[2]."' maxlength=4 size=4 class='textbox' com_numeric=true validation='false' title='대표번호'>
		</td>
	    <td class='input_box_title'> <b>팩스번호</b></td>
		<td class='input_box_item'>
			<input type=text name='com_fax_1' id='com_mobile_1' value='".$com_fax[0]."' maxlength=4 size=4  class='textbox' com_numeric=true validation='false' title='팩스'> -
			<input type=text name='com_fax_2' id='com_mobile_2' value='".$com_fax[1]."' maxlength=4 size=4 class='textbox' com_numeric=true validation='false' title='팩스'> -
			<input type=text name='com_fax_3' id='com_mobile_3' value='".$com_fax[2]."' maxlength=4 size=4 class='textbox' com_numeric=true validation='false' title='팩스'>
		</td>
	  </tr>
	  <tr>
		...
		if($disp_type == "clipart"){
			$mString = '<table width="100%" id="productList_1" name="productList" class="list_table_box" >
							<tr height="25">
								...
								<td class="m_td" width="7%" rowspan="2">매입가</td>
								<td class="m_td" width="7%" rowspan="2">정가</td>
								<td class="m_td" width="8%" rowspan="2">판매가(할인가)</td>
								<td class="m_td" width="7%" rowspan="2">에누리액</td>
								<td class="m_td" width="7%" rowspan="2">에누리단가</td>
								<td class="m_td"  width="4%"rowspan="2">수량</td>
			
								<td class="m_td" width="20%" colspan="3">에누리견적가</td>
								<td class="m_td"width="5%" rowspan="2">할인율%</td>
				...
				$mString .= "
						...
						$mString .= "			<td align='center'>
							...
							$mString .= "
										...
										$mString .= "<span style='color:#007DB7;font-weight:bold;' >".$ddb->dt[od_ix]." ".($ddb->dt[co_oid] ? "(".$ddb->dt[co_oid].")" : "")."</span><br/>";

										$mString .= "<a href='../product/goods_input.php?id=".$ddb->dt[pid]."' target=_blank />";

										$mString .= $ddb->dt[pname];
										$mString .= "</a>";
