	...
	<tr>
		<td style='padding:10px;vertical-align: top; '>
			...
			<table border=0 width=380 cellpadding=0>
				<tr >
					<td style='padding:3px;' align=center><b>파일경로</b></td>
					<td style='padding:3px;'>".$page_path."</td>
				</tr>
				<tr height=1><td colspan=2 class='dot-x'></td></tr>
				<tr >
					<td style='padding:3px;' align=center><b>파일이름 <img src='".$required_path."'></b></td>
					<td style='padding:3px;'><input type=text name='filename' size=20 class=s validation='true' title='파일이름'></td>
				</tr>
				<tr height=1><td colspan=2 class='dot-x'></td></tr>
				<tr>
					<td style='padding:3px;' align=center colspan=2>
