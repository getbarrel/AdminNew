...
// 	}
	...
	$Contents .= "
	<table class='layer_box' border=0 cellpadding=0 cellspacing=0 style='width:850px;height:466px;' >
		<col width='11px'>
		<col width='*'>
		<col width='11px'>
		<tr>
		...
		<tr>
			...
			<tr>
				...
				<td valign=top width='100%'>
					...
					<tr>
						<td width=170 nowrap >접근 URL</td>
						<td width=100% nowrap>
						<table cellpadding=0 cellspacing=0>
							<tr>
								<td><input type='text' class='textbox' name='basic_link' validation=true urltype=true style='ime-mode:disabled;' size=30 title='접근 URL'></td>
					...
					<tr>
						...
						<td width=100% nowrap>
							<input type='radio' name='category_display_type' id='category_display_type_folder2' value='F' onclick=\"document.getElementById('bbs_select').style.display='none'; \" checked><label for='category_display_type_folder2'>분류(폴더)</label>
							<input type='radio' name='category_display_type' id='category_display_type_html2' value='P' onclick=\"document.getElementById('bbs_select').style.display='none'; \"><label for='category_display_type_html2'> 페이지(html)</label>
							<input type='radio' name='category_display_type' id='category_display_type_bbs2' value='B' onclick=\"document.getElementById('bbs_select').style.display='block'; \"><label for='category_display_type_bbs2'> 게시판</label>
	...
	<table cellpadding=2 cellspacing=0 class='small' >
		<col width=8>
		<col width=*>
		<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' style='line-height:140%;'><b>카테고리 수정</b> : 수정하고자 하는 카테고리를 먼저 선택하신후 내용을 수정하신후 카테고리 수정 버튼을 클릭하시면 됩니다</td></tr>
		<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' style='line-height:140%;'><b>카테고리 추가</b> : 추가를 원하시는  카테고리를 먼저 선택하신후 상단에 분류및 페이지 추가 버튼을 클릭하신후 정보입력후 카테고리 추가  버튼을 클릭하시면 됩니다</td></tr>
		<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' style='line-height:140%;'>카테고리 구성정보를 입력하시면 기본레이아웃을 바탕으로 레이이아웃 기본정보가 입력되며 팔일또한 생성됩니다</td></tr>
		<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' style='line-height:140%;'><b>기본링크 (표시URL)</b> 에  추가하신 페이지에서 사용하고자 하는 URL을 입력하세요 예) /page.php </td></tr>
	</table>
	";
	...
	$Contents .="
					...
					<tr id='bbs_select2' style='display:none;'>
						<td nowrap>게시판 선택 </td>
						<td nowrap>".BoardSelect($page_name)."<td>
					</tr>
					";
	...
	$Contents .= "
			...
			<iframe name='calculation_frm' src='' width=0 height=0></iframe>
			</td>
			<th class='box_06'></th>
		</tr>
		<tr>
