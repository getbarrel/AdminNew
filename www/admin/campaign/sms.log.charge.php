...
$page_title = "S/LMS 총비용통계";
$page_navigation = "메일링/SMS > SMS 발송 분석기 > S/LMS 총비용통계";
...
$sms_design = new SMS;
	...
	$mstring .="
			...
			<tr>
				<td>";
	if($_GET["license"]){
		$mstring .=  $sms_design->getSMSProductLogChargeUTF8($_GET, $regdate);
	}else{
		$mstring .=  $sms_design->getSMSProductLogChargeUTF8($admininfo, $regdate);
	}
