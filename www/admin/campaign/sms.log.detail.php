...
$sms_design = new SMS;
												...
												<col width='32%'>
												 <tr height='27'>
													<th class='search_box_title' bgcolor='#efefef' width='100' align='center'>
														<select name='date_type'>
															<option value='request_time' ".CompareReturnValue('request_time',$date_type,' selected').">발송일자</option>
												 ...
												 <tr height='27'>
													...
													<td class='search_box_item'>
														<input type='checkbox' name='send_type[]' id='send_auto' value='A' ".CompareReturnValue("A",$send_type,"checked")."><label for='send_auto'>자동발송</label>
														<input type='checkbox' name='send_type[]' id='send_hand' value='M' ".CompareReturnValue("M",$send_type,"checked")."><label for='send_hand'>수동발송</label>
													</td>
													<th class='search_box_title' bgcolor='#efefef' width='100' align='center'>SMS/LMS/MMS 구분</th>
													<td class='search_box_item'>
														...
														<input type='checkbox' name='sms_type[]' id='mms' value='8' ".CompareReturnValue("8",$sms_type,"checked")."><label for='mms'>MMS</label>
													</td>
												 </tr>
												 <tr height='27'>
	...
	$mstring .="
			...
			<tr>
				<td>";
	if($_GET["license"]){
		$mstring .=  $sms_design->getSMSProductLogDetailUTF8($_GET, $regdate);
	}else{
		$mstring .=  $sms_design->getSMSProductLogDetailUTF8($admininfo, $regdate);
	}
