...
function ReportTable($vdate,$SelectReport=1){
    ...
    if($SelectReport == 1){
        ...
        $sql = "Select d.nh00/v.nh00, d.nh01/v.nh01, d.nh02/v.nh02, d.nh03/v.nh03, d.nh04/v.nh04, d.nh05/v.nh05, d.nh06/v.nh06,
            ...
            d.nh23/v.nh23 from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where v.vdate = '$vdate' and v.vdate = d.vdate";
        */
        $sql = "Select
			...
			from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where v.vdate = '$vdate' and v.vdate = d.vdate";
        if($fordb1->dbms_type == "oracle"){
            /*
            $sql1 = "Select TO_CHAR(avg(d.nh00)/avg(v.nh00),'9,999,999.9'), TO_CHAR(avg(d.nh01)/avg(v.nh01),'9,999,999.9'), TO_CHAR(avg(d.nh02)/avg(v.nh02),'9,999,999.9'), TO_CHAR(avg(d.nh03)/avg(v.nh03),'9,999,999.9'), TO_CHAR(avg(d.nh04)/avg(v.nh04),'9,999,999.9'), TO_CHAR(avg(d.nh05)/avg(v.nh05),'9,999,999.9'),
            TO_CHAR(avg(d.nh06)/avg(v.nh06),'9,999,999.9'), TO_CHAR(avg(d.nh07)/avg(v.nh07),'9,999,999.9'), TO_CHAR(avg(d.nh08)/avg(v.nh08),'9,999,999.9'), TO_CHAR(avg(d.nh09)/avg(v.nh09),'9,999,999.9'), TO_CHAR(avg(d.nh10)/avg(v.nh10),'9,999,999.9'), TO_CHAR(avg(d.nh11)/avg(v.nh11),'9,999,999.9'),
            TO_CHAR(avg(d.nh12)/avg(v.nh12),'9,999,999.9'), TO_CHAR(avg(d.nh13)/avg(v.nh13),'9,999,999.9'), TO_CHAR(avg(d.nh14)/avg(v.nh14),'9,999,999.9'), TO_CHAR(avg(d.nh15)/avg(v.nh15),'9,999,999.9'), TO_CHAR(avg(d.nh16)/avg(v.nh16),'9,999,999.9'), TO_CHAR(avg(d.nh17)/avg(v.nh17),'9,999,999.9'),
            TO_CHAR(avg(d.nh18)/avg(v.nh18),'9,999,999.9'), TO_CHAR(avg(d.nh19)/avg(v.nh19),'9,999,999.9'), TO_CHAR(avg(d.nh20)/avg(v.nh20),'9,999,999.9'), TO_CHAR(avg(d.nh21)/avg(v.nh21),'9,999,999.9'), TO_CHAR(avg(d.nh22)/avg(v.nh22),'9,999,999.9'), TO_CHAR(avg(d.nh23)/avg(v.nh23),'9,999,999.9')
            from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where substr(v.vdate,1,6) = '".substr($vdate,0,6)."' ";
            */
            $sql1 = "Select
				case when IFNULL(sum(v.nh00),0) = 0 then 0 else TO_NUMBER(avg(d.nh00)/avg(v.nh00),'9,999,999.9') end,
				case when IFNULL(sum(v.nh01),0) = 0 then 0 else TO_NUMBER(avg(d.nh01)/avg(v.nh01),'9,999,999.9') end,
				case when IFNULL(sum(v.nh02),0) = 0 then 0 else TO_NUMBER(avg(d.nh02)/avg(v.nh02),'9,999,999.9') end,
				case when IFNULL(sum(v.nh03),0) = 0 then 0 else TO_NUMBER(avg(d.nh03)/avg(v.nh03),'9,999,999.9') end,
				case when IFNULL(sum(v.nh04),0) = 0 then 0 else TO_NUMBER(avg(d.nh04)/avg(v.nh04),'9,999,999.9') end,
				case when IFNULL(sum(v.nh05),0) = 0 then 0 else TO_NUMBER(avg(d.nh05)/avg(v.nh05),'9,999,999.9') end,
				case when IFNULL(sum(v.nh06),0) = 0 then 0 else TO_NUMBER(avg(d.nh06)/avg(v.nh06),'9,999,999.9') end,
				case when IFNULL(sum(v.nh07),0) = 0 then 0 else TO_NUMBER(avg(d.nh07)/avg(v.nh07),'9,999,999.9') end,
				case when IFNULL(sum(v.nh08),0) = 0 then 0 else TO_NUMBER(avg(d.nh08)/avg(v.nh08),'9,999,999.9') end,
				case when IFNULL(sum(v.nh09),0) = 0 then 0 else TO_NUMBER(avg(d.nh09)/avg(v.nh09),'9,999,999.9') end,
				case when IFNULL(sum(v.nh10),0) = 0 then 0 else TO_NUMBER(avg(d.nh10)/avg(v.nh10),'9,999,999.9') end,
				case when IFNULL(sum(v.nh11),0) = 0 then 0 else TO_NUMBER(avg(d.nh11)/avg(v.nh11),'9,999,999.9') end,
				case when IFNULL(sum(v.nh12),0) = 0 then 0 else TO_NUMBER(avg(d.nh12)/avg(v.nh12),'9,999,999.9') end,
				case when IFNULL(sum(v.nh13),0) = 0 then 0 else TO_NUMBER(avg(d.nh13)/avg(v.nh13),'9,999,999.9') end,
				case when IFNULL(sum(v.nh14),0) = 0 then 0 else TO_NUMBER(avg(d.nh14)/avg(v.nh14),'9,999,999.9') end,
				case when IFNULL(sum(v.nh15),0) = 0 then 0 else TO_NUMBER(avg(d.nh15)/avg(v.nh15),'9,999,999.9') end,
				case when IFNULL(sum(v.nh16),0) = 0 then 0 else TO_NUMBER(avg(d.nh16)/avg(v.nh16),'9,999,999.9') end,
				case when IFNULL(sum(v.nh17),0) = 0 then 0 else TO_NUMBER(avg(d.nh17)/avg(v.nh17),'9,999,999.9') end,
				case when IFNULL(sum(v.nh18),0) = 0 then 0 else TO_NUMBER(avg(d.nh18)/avg(v.nh18),'9,999,999.9') end,
				case when IFNULL(sum(v.nh19),0) = 0 then 0 else TO_NUMBER(avg(d.nh19)/avg(v.nh19),'9,999,999.9') end,
				case when IFNULL(sum(v.nh20),0) = 0 then 0 else TO_NUMBER(avg(d.nh20)/avg(v.nh20),'9,999,999.9') end,
				case when IFNULL(sum(v.nh21),0) = 0 then 0 else TO_NUMBER(avg(d.nh21)/avg(v.nh21),'9,999,999.9') end,
				case when IFNULL(sum(v.nh22),0) = 0 then 0 else TO_NUMBER(avg(d.nh22)/avg(v.nh22),'9,999,999.9') end,
				case when IFNULL(sum(v.nh23),0) = 0 then 0 else TO_NUMBER(avg(d.nh23)/avg(v.nh23),'9,999,999.9') end
			from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where substr(v.vdate,1,6) = '".substr($vdate,0,6)."' and v.vdate = d.vdate";
        }else{
			...
			from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where substring(v.vdate,1,6) = '".substr($vdate,0,6)."' and v.vdate = d.vdate";
        }
        /*
        $sql2 = "Select d.nh00/v.nh00, d.nh01/v.nh01, d.nh02/v.nh02, d.nh03/v.nh03, d.nh04/v.nh04, d.nh05/v.nh05, d.nh06/v.nh06,
            d.nh07/v.nh07, d.nh08/v.nh08, d.nh09/v.nh09, d.nh10/v.nh10, d.nh11/v.nh11, d.nh12/v.nh12, d.nh13/v.nh13, d.nh14/v.nh14,
            d.nh15/v.nh15, d.nh16/v.nh16, d.nh17/v.nh17, d.nh18/v.nh18, d.nh19/v.nh19, d.nh20/v.nh20, d.nh21/v.nh21, d.nh22/v.nh22,
            d.nh23/v.nh23 from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where v.vdate = '$vyesterday' and v.vdate = d.vdate";
        */
        $sql2 = "Select
			case when IFNULL(v.nh00,0) = 0 then 0 else d.nh00/v.nh00 end,
			case when IFNULL(v.nh01,0) = 0 then 0 else d.nh01/v.nh01 end,
			...
			case when IFNULL(v.nh22,0) = 0 then 0 else d.nh22/v.nh22 end,
			case when IFNULL(v.nh23,0) = 0 then 0 else d.nh23/v.nh23 end
			from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where v.vdate = '$vyesterday' and v.vdate = d.vdate";
        /*
        $sql3 = "Select d.nh00/v.nh00, d.nh01/v.nh01, d.nh02/v.nh02, d.nh03/v.nh03, d.nh04/v.nh04, d.nh05/v.nh05, d.nh06/v.nh06,
            d.nh07/v.nh07, d.nh08/v.nh08, d.nh09/v.nh09, d.nh10/v.nh10, d.nh11/v.nh11, d.nh12/v.nh12, d.nh13/v.nh13, d.nh14/v.nh14,
            d.nh15/v.nh15, d.nh16/v.nh16, d.nh17/v.nh17, d.nh18/v.nh18, d.nh19/v.nh19, d.nh20/v.nh20, d.nh21/v.nh21, d.nh22/v.nh22,
            d.nh23/v.nh23 from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where v.vdate = '$voneweekago' and v.vdate = d.vdate";
        */
        $sql3 = "Select
			case when IFNULL(v.nh00,0) = 0 then 0 else d.nh00/v.nh00 end,
			case when IFNULL(v.nh01,0) = 0 then 0 else d.nh01/v.nh01 end,
			...
			case when IFNULL(v.nh22,0) = 0 then 0 else d.nh22/v.nh22 end,
			case when IFNULL(v.nh23,0) = 0 then 0 else d.nh23/v.nh23 end
			from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where v.vdate = '$voneweekago' and v.vdate = d.vdate";
        ...
        $sql .= " from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d
        ...
        $sql2 .= " from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d
        ...
        $sql3 .= " from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d
        ...
        $sql .= "from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where v.vdate LIKE '".substr($vdate,0,6)."%' and d.vdate LIKE '".substr($vdate,0,6)."%' ";
        ...
        $sql2 .= "from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d  where v.vdate LIKE '".substr($vonemonthago,0,6)."%' and d.vdate LIKE '".substr($vonemonthago,0,6)."%' ";
        ...
        $sql3 .= "from ".TBL_LOGSTORY_VISITOR." v, ".TBL_LOGSTORY_DURATIONTIME." d where v.vdate LIKE '".substr($vtwomonthago,0,6)."%' and d.vdate LIKE '".substr($vtwomonthago,0,6)."%' ";
...
//	echo $sql3 ."<br>";
    ...
    if($SelectReport == 1){
        ...
        $mstring = $mstring.TitleBar("순수방문자 당 체류시간 ","일간 : ". getNameOfWeekday(0,$vdate,"dayname"));
        $mstring .= "<table cellpadding=0 cellspacing=0 width=100% border=0>\n";
        //$mstring .= "<tr  align=center><td colspan=3 style='padding-bottom:10px;'><img src='durationbyvisitor.chart.php?vdate=".$vdate."&SelectReport=".$SelectReport."'></td></tr>\n";
        ...
        /*
            ...
            <td class=m_td style='padding-right:20px;'>".displayTimeFormat($pageview02)."</td>
            ...
            $mstring .= "</table>\n";
        */
        $mstring = str_replace("{{MAXVALUE}}",displayTimeFormat($maxvalue),$mstring);
        $mstring = str_replace("{{MINVALUE}}",displayTimeFormat($minvalue),$mstring);
        ...
        $mstring = $mstring.TitleBar("순수방문자 당 체류시간",getNameOfWeekday(0,$vdate)."~".getNameOfWeekday(6,$vdate));
        $mstring .= "<table cellpadding=0 cellspacing=0 width=100% border=0>\n";
        //$mstring .= "<tr  align=center><td colspan=3 style='padding-bottom:10px;'><img src='durationbyvisitor.chart.php?vdate=".$vdate."&SelectReport=".$SelectReport."'></td></tr>\n";
        $mstring .= "<tr  align=center><td colspan=3 style='padding-bottom:10px;'><div id='line-chart' style='height: 300px; position: relative;'></div></td></tr>\n";
        $mstring .= "<tr  align=center><td colspan=3 ></td></tr>\n";
		...
		<!--td bgcolor=#efefef align=right id='Report$i' onmouseover=\"mouseOnTD('$i',true)\" onmouseout=\"mouseOnTD('$i',false)\" style='padding-right:20px;'>".displayTimeFormat(returnZeroValue($fordb1->dt[$i]))."</td-->
        ...
        */
        ...
        $mstring = $mstring.TitleBar("순수방문자 당 체류시간",getNameOfWeekday(0,$vdate,"monthname"));
        $mstring .= "<table cellpadding=0 cellspacing=0 width=100% border=0>\n";
        //$mstring .= "<tr  align=center><td colspan=3 style='padding-bottom:10px;'><img src='durationbyvisitor.chart.php?vdate=".$vdate."&SelectReport=".$SelectReport."'></td></tr>\n";
        $mstring .= "<tr  align=center><td colspan=3 style='padding-bottom:10px;'><div id='line-chart' style='height: 300px; position: relative;'></div></td></tr>\n";
        $mstring .= "<tr  align=center><td colspan=3 ></td></tr>\n";
        ...
        $mstring .= "<table cellpadding=3 cellspacing=0 width=100%  ID='MaxViewProductTable' class='list_table_box'>\n";
        $mstring .= "<tr height=30 align=center><td class=s_td width=25%>날짜</td><td class=m_td width=25%>해당월</td><!--td class=m_td width=25%>한달평균</td--><td class=m_td width=25%>1개월전 </td><td class=e_td width=25%>2개월전 </td></tr>\n";
    ...
    /*
        ...
        <table>
            <tr>
                ...
                - 순수방문자당 체류시간이란 ? 순수방문자 1인당 사이트에 체류한 시간을 나타내는 리포트로 순수방문자의 사이트의 관심도, 충성도를 보여주는 리포트 입니다<br>
                - 순수방문자당 체류시간을 시간대별로 보여주고 있으며, 주간리포트는 요일별, 월간리포트는 일자별로 제공됩니다<br>
    ...
    $mstring .= HelpBox("순수방문자당 체류시간", $help_text);
...
//	echo "<Script>parent.document.getElementById('contents_frame').innerHTML = document.tablefrm.reportvalue.value</Script>";
    ...
    $ca = new Calendar();
    $ca->LinkPage = 'durationbyvisitor.php';
...
//	echo "<Script>parent.document.getElementById('calendararea').innerHTML = document.calendarfrm.calendarvalue.value;parent.vdate;parent.ChangeCalenderView($SelectReport);</Script>";
    ...
    $p->Navigation = "로그분석 > 순수방문자 분석 > 순수방문자 당 체류시간";
    $p->title = "순수방문자 당 체류시간";
    $p->forbizLeftMenu = Stat_munu('durationbyvisitor.php');
