...
function ChangeReport(value) {	
	...
	if(value == 1 || value == 2){
		$('#calendar_month_view').css('display','none');
		$('#calendar_day_view').css('display','block');
		ChangeCalenderView(value);
	}else if(value == 3){
		$('#calendar_month_view').css('display','block');
		$('#calendar_day_view').css('display','none');
...
function ViewReport(LinkPage, vDate){
	...
	if(SelectReport == 1){
		...
		//document.getElementById('act').src=LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
		if(mode == "iframe"){
			window.frames['act'].location.href = LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
		}else{
			window.location.href = LinkPage+'?vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
		}
	}else if(SelectReport == 2){
		//document.frames['act'].location.href=LinkPage+'?vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport; // 호환성 오류 2011-04-05 kbk
		//document.getElementById('act').src=LinkPage+'?vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
		if(mode == "iframe"){
			window.frames['act'].location.href = LinkPage+'?mode=iframe&vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
		}else{
			window.location.href = LinkPage+'?vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
		}
	}else if(SelectReport == 3){
		//document.frames['act'].location.href=LinkPage+'?vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport; // 호환성 오류 2011-04-05 kbk
		//document.getElementById('act').src=LinkPage+'?vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
		if(mode == "iframe"){
			window.frames['act'].location.href = LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
		}else{
			window.location.href = LinkPage+'?vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport;
...
function ViewTreeRefererReport(LinkPage, vDate,vName, vreferid,vdepth){
	if(vNewdate != ""){
		vDate = vNewdate;
	}
	//alert(vreferid);
	...
	if(SelectReport == 1){
		...
		if(mode == "iframe"){
			window.frames['act'].location.href = LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;
		}else{
			window.location.href = LinkPage+'?vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;
		}
	}else if(SelectReport == 2){
		...
		if(mode == "iframe"){
			window.frames['act'].location.href =  LinkPage+'?mode=iframe&vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;
		}else{
			window.location.href =  LinkPage+'?vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid;
		}
	}else if(SelectReport == 3){
		//document.frames['act'].location.href=LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+vreferid; // 호환성 오류 2011-04-05 kbk
		...
		if(mode == "iframe"){
			window.frames['act'].location.href =  LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid;
		}else{
			window.location.href =  LinkPage+'?vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid;
		}
	}
	blockLoading();
}
...
function ViewTreeReport(LinkPage, vDate,vName, cid,vdepth,search_sdate,search_edate){
	if(vNewdate != ""){
		vDate = vNewdate;
	}
	//alert(cid);
	var mode = "";
	if(SelectReport == 1){
		//document.location.href=LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid;
		//document.frames['act'].location.href=LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid; // 호환성 오류 2011-04-05 kbk
		//document.getElementById('act').src=LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid;
		if(mode == "iframe"){
			window.frames['act'].location.href = LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&cid='+cid;
		}else{
			window.location.href = LinkPage+'?vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&cid='+cid;
		}
	}else if(SelectReport == 2){
		//document.location.href=LinkPage+'?vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid;
		//document.frames['act'].location.href=LinkPage+'?mode=iframe&vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid; // 호환성 오류 2011-04-05 kbk
		//document.getElementById('act').location.href=LinkPage+'?mode=iframe&vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid;
		if(mode == "iframe"){
			window.frames['act'].location.href =  LinkPage+'?mode=iframe&vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&cid='+cid;
		}else{
			window.location.href =  LinkPage+'?vdate='+printWeek(vDate)+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&cid='+cid;
		}
	}else if(SelectReport == 3){
		//document.frames['act'].location.href=LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid; // 호환성 오류 2011-04-05 kbk
		//document.getElementById('act').location.href=LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&referer_id='+cid;
		//alert(LinkPage);
		if(mode == "iframe"){
			window.frames['act'].location.href =  LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&cid='+cid;
		}else{
		...
		if(mode == "iframe"){
			window.frames['act'].location.href =  LinkPage+'?mode=iframe&vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&cid='+cid+'&search_sdate='+search_sdate+'&search_edate='+search_edate;
		}else{
			window.location.href =  LinkPage+'?vdate='+vDate+'&SubID='+SMinitiallyOpenSub11464+'&SelectReport='+SelectReport+'&depth='+vdepth+'&cid='+cid+'&search_sdate='+search_sdate+'&search_edate='+search_edate;
		}
	}
	blockLoading();
}
...
function formatDate(date) {
	...
	var myyear = date.getFullYear();// 호환용 ksh 12/04/02
...
function printWeekx(vdate) {
	...
	var nowYear = now.getFullYear();// 호환용 ksh 12/04/02
	nowYear += (nowYear < 2000) ? 1900 : 0;
