...
/** report icon */
var REPORT_ICON = "../commonimg//SiteReport_Report.gif";

/** Data Icon */
var DATA_ICON = "../commonimg//Common_Data.gif";


/** System Defined Buttons */
var ADD_BUTTON = "../commonimg//Common_Add.gif";
var DELETE_BUTTON = "../commonimg//Common_Delete.gif";
var PROPERTY_BUTTON = "../commonimg//Common_Property.gif";
var OK_BUTTON = "../commonimg//Common_Ok.gif";
var CANCEL_BUTTON = "../commonimg//Common_Cancel.gif";
var EDIT_BUTTON = "../commonimg//Common_Edit.gif";
var FIND_BUTTON = "../commonimg//Common_Find.gif";
var DOWNLOAD_EXCEL_BUTTON = "../commonimg//Common_Download_Excel.gif";
var HELP_BUTTON = "../commonimg//Common_Help.gif";
var NEXT_BUTTON = "../commonimg//Common_Next.gif";
var PREV_BUTTON = "../commonimg//Common_Prev.gif";
var CHANGENAME_BUTTON = "../commonimg//Common_ChangeName.gif";
var MERGE_FRAME_BUTTON = "../commonimg//Common_Merge_Frame.gif";
var DIVIDE_FRAME_BUTTON = "../commonimg//Common_Divide_Frame.gif";
var PRINT_BUTTON = "../commonimg//Common_Print.gif";
var SAVE_BUTTON = "../commonimg//Common_Save.gif";
var SAVEAS_BUTTON = "../commonimg//Common_SaveAs.gif";
var SMALLER_BUTTON = "../commonimg//Common_Smaller.gif";
var LARGER_BUTTON = "../commonimg//Common_Larger.gif";
var OPEN_BUTTON ="../commonimg//Common_Open.gif";
var EXECUTE_BUTTON = "../commonimg//Common_Ok.gif";
var CLOSE_BUTTON = "../commonimg//Common_Close.gif";

var ADD_BUTTONICON = "../commonimg//Common_Button_Add.gif";
var EDIT_BUTTONICON = "../commonimg//Common_Button_Edit.gif";
var MODIFY_BUTTONICON = "../commonimg//Common_Button_Modify.gif";
var DELETE_BUTTONICON = "../commonimg//Common_Button_Delete.gif";
var CANCEL_BUTTONICON = "../commonimg//Common_Button_Cancel.gif";
var VIEW_BUTTONICON = "../commonimg//Common_Button_View.gif";
var UP_BUTTONICON = "../commonimg//Common_Button_Up.gif";
var DOWN_BUTTONICON = "../commonimg//Common_Button_Down.gif";
var SAVE_BUTTONICON = "../commonimg//Common_Button_Save.gif";
var SELECT_BUTTONICON = "../commonimg//Common_Button_Select.gif";
var SEARCH_BUTTONICON = "../commonimg//Common_Button_Search.gif";
var OK_BUTTONICON = "../commonimg//Common_Button_OK.gif";
var INIT_BUTTONICON = "../commonimg//Common_Button_Init.gif";
var REGISTER_BUTTONICON = "../commonimg//Common_Button_Register.gif";
var SERVERSTART_BUTTONICON = "../commonimg//Common_Button_ServerStart.gif";
var SERVERSTOP_BUTTONICON = "../commonimg//Common_Button_ServerStop.gif";
var EXAMINE_BUTTONICON = "../commonimg//Common_Button_Examine.gif";
var NEXT_BUTTONICON = "../commonimg//Common_Button_Next.gif";
var PREV_BUTTONICON = "../commonimg//Common_Button_Prev.gif";



var DATA_LIST = "../commonimg//Common_List_Data.gif";
var DATASELECTED_LIST = "../commonimg//Common_List_DataSelected.gif";
var USER_LIST = "../commonimg//Common_List_User.gif";
var USERSELECTED_LIST = "../commonimg//Common_List_UserSelected.gif";
var MESSAGE_LIST = "../commonimg//Common_List_Message.gif";
var MESSAGESELECTED_LIST = "../commonimg//Common_List_MessageSelected.gif";
