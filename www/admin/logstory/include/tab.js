...
function tabToggle(tabID){
	...
	if ((lastTab != tabID) && (lastTab != null)){
		...
		lastTab.style.top = "3";
		lastTab.style.backgroundImage='url(../report/img/UI_graytab.gif)';
	...
	if (tabID.style.zIndex == "3"){
	  	...
	  	tabID.style.top = "0";
		tabID.style.backgroundImage='url(../report/img/UI_bluetab.gif)';
		...
		tabID.style.fontWeight='bold';
		tabID.style.paddingTop='4px';		
		document.getElementById(tabID.id+"_arrow").src="../report/img/bule_arrow.gif";		
   		lastTab = tabID;
    }
}
