...
<table width='100%' cellpadding='0' cellspacing='0' border=0>
	<tr>
		<td align='left' colspan=6 > ".GetTitleNavigation("찜상품 보기", "이커머스분석 > 고객종합분석(CRM) > 찜상품 보기 ")."</td>
	</tr>
</table>
<table width='100%' cellpadding='0' cellspacing='0' border=0>
	<tr>
					...
					<td align='left' colspan=2   width='100%' valign=top>
						...
						<col width=35%>
							...
							<tr height=33>
								...
								<td class='search_box_item'  colspan=3>
									".search_date2('startDate','endDate',$startDate,$endDate)."
								</td>
							</tr>
						</table>
					</td>
...
$Contents .= HelpBox("찜상품 보기", $help_text);
    ...
    $p->addScript = "".$Script;
    $p->forbizLeftMenu = commerce_munu('view_wishlist.php',"",$searchview);
    $p->forbizContents = $Contents;
    $p->Navigation = "이커머스분석 > 고객종합분석(CRM) > 찜상품 보기";
    $p->title = "찜상품 보기";
    $p->PrintReportPage();
