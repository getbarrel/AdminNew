...
$Contents01 = "
	<table width='100%' cellpadding=0 cellspacing=0 border='0' align='left'>
	  <tr >
			<td align='left'> ".GetTitleNavigation("공유 서버관리", "도매아이템 > 공유 서버관리 ")."</td>
	  </tr>
	  <tr>
	    <td align='left'>
			<table cellpadding='0' cellspacing='0' border='0' width='100%'>
				<tr>
					<td>".colorCirCleBox("#efefef","100%","<div style='padding:5px;padding-left:10px;'> <img src='../image/title_head.gif' align=absmiddle> <b  class=blk>공유 서버 정보</b></div>")."</td>
				</tr>
			</table>
		</td>
	  </tr>
...
$Contents02 = "
	<table width='100%' cellpadding=0 cellspacing=0 border='0' align='left' >
	  <tr>
	    <td align='left' colspan=6> ".colorCirCleBox("#efefef","100%","<div style='padding:5px 5px 5px 15px;'><img src='../image/title_head.gif' align=absmiddle> <b class=blk>공유 서버 목록</b></div>")."</td>
	  </tr>
	</table>
