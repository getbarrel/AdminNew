...
$innerview = "
			...
			<tr height=30>
				...
				if ($mode == ""){
					$innerview .= "
					<a href='profit_status.php?".str_replace("mode=", "mode=excel",$search_query)."'><img src='../images/".$admininfo["language"]."/btn_excel_save.gif' border=0></a>";
				}else{
					$innerview .= "
					<a href='profit_status.php?".str_replace("mode=search", "mode=excel",$search_query)."'><img src='../images/".$admininfo["language"]."/btn_excel_save.gif' border=0></a>";
				}	$innerview .= "
				</td>
				</tr></table>
			...
			<tr bgcolor='#cccccc' height=30 align=center>
			  ...
			  <td width='20%' class=m_td rowspan=2>이미지/상품명</td>
			  <td width='15%' class=m_td rowspan=2>옵션명</td>
			  ...
			  <td width='*' class=e_td rowspan=2>이익율</td>
			</tr>
			<tr>
