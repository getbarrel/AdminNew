...
if($act == "insert"){
	...
	if($customer_div == "1"){
		...
		$sql = "insert into inventory_customer_info 
					(customer_div,customer_name,customer_phone,customer_fax,customer_msg, regdate) 
					values 
					('$customer_div','$customer_name','$customer_phone','$customer_fax','$customer_msg',NOW())";
		*/
		$sql = "insert into inventory_customer_info set 
					ci_ix='".$ci_ix."',
		...
		$sql = "
		insert into inventory_company_detail set 
		ci_ix='".$ci_ix."',
		com_name='".$com_name."',
		com_div='".$com_div."',
		com_ceo='".$com_ceo."',
...
if($act == "delete"){
	if($customer_div == "E"){
		$db->query("delete from inventory_customer_info where c_ix = '".$c_ix."'");
