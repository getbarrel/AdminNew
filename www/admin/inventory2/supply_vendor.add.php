...
if($ci_ix == ""){
	...
	$db->query("SELECT * FROM inventory_customer_info WHERE ci_ix = '".$ci_ix."' and customer_type = 'E'");
...
$Contents01 = "
	<table width='100%' cellpadding=0 cellspacing=0 border='0' align='left' style='padding: 0px 0px 5px 0px'>
	  ...
	  <col width=32% />
	  <tr>
	    <td align='left' colspan=6> ".GetTitleNavigation("$title", "재고관리 > $title")."</td>
	</tr>
	  <tr>
	    <td align='left' colspan=4 > ".colorCirCleBox("#efefef","100%","<div style='padding:5px 5px 5px 15px;' onclick='set_testdata();'><img src='../image/title_head.gif' ><b> 입고처 정보</b></div>")."</td>
	  </tr>
</table><br>
<table width='100%' cellpadding=0 cellspacing=0 border='0' class='input_table_box'  style='border-collapse:separate; border-spacing:1px;'>
	   ...
	   <tr bgcolor=#ffffff>
		...
		<td class='input_box_item'>
			...
			$Contents01 .= "<b>자사입고처</b> <input type='hidden' name='customer_div' id='customer_div_1' value='1' >";
				...
				$Contents01 .= "<input type='radio' name='customer_div' id='customer_div_1' value='1' ".($basic_info[customer_div] == "1" || $basic_info[customer_div] == "" ? "checked":"")." onclick=\"$('.sale_agency_info').hide();\"><label for='customer_div_1'>자사입고처</label>
				...
				<input type='radio' name='customer_div' id='customer_div_9' value='9' ".($basic_info[customer_div] == "9"  ? "checked":"")." onclick=\"$('.sale_agency_info').show();\"><label for='customer_div_9'>타사입고처</label>";
			}
			$Contents01 .= "
		</td>
		<td class='input_box_title'> <b>입고처 구분 <img src='".$required3_path."'></b></td>
	  ...
	  <table width='100%' cellpadding=0 cellspacing=1 border='0' bgcolor=silver style='border-collapse:separate; border-spacing:1px;".($basic_info[customer_div] != "9" || $basic_info[customer_div] == "" ? "display:none;":"")."' class='sale_agency_info input_table_box' >
	  <col width=18% />
	  <col width=32% />
	  <col width=18% />
	  <col width=32% />
	  ...
	  <tr bgcolor=#ffffff height=34>
		...
		<td class='input_box_item'><input type=text name='com_email' value='".$company_info[com_email]."' class='textbox'  style='width:200px' validation='false' title='대표이메일' email=true></td>
	  </tr>
	  <tr bgcolor=#ffffff height=34>
	...
	<table width='100%' cellpadding=0 cellspacing=0 border='0' class='sale_agency_info' ".($basic_info[customer_div] != "9" || $basic_info[customer_div] == "" ? "style='display:none;'":"").">
	  ...
	  <tr bgcolor=#ffffff height=34 >
		...
		<td  class='input_box_item'><input type=text name='charger_email' value='".$company_info[charger_email]."' class='textbox'  style='width:200px' validation='false' title='담당자 이메일' email=true></td>
...
$Contents = $Contents."<tr><td>".$ButtonString."</td></tr></form>";
