...
$innerview .= "
			...
			<tr height=30 align=center>
				...
				<td class=m_td>보관장소 전화번호</td>
				<td class=m_td>보관장소 FAX</td>
...
if($db->total == 0){
	...
	$innerview .= "<tr height=50 class='dot_xx'  onclick=\"spoit(this)\" id='".$db->dt[pi_ix]."'>					
...
<table cellpadding=0 cellspacing=0 class='small' >
	<col width=8>
	<col width=*>
	<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' >보관장소 우선순위는 재고가 소진될때 어느보관장소의 재고를 먼저 소진할지 지정해주는 메뉴입니다.</td></tr>
	<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' >우선순위를 변경하시고자 할때 <b>↑ ↓ 방향키</b>를 눌러서 이동하신후 <b>저장</b>버튼을 누르시면 저장됩니다</td></tr>
	<tr><td valign=top><img src='/admin/image/icon_list.gif' ></td><td class='small' >상품별로 지정하기 위해선 상품리스트에서 '보관장소우선순위' 버튼을 클릭하시고 설정하면 됩니다.</td></tr>
</table>
";

$Contents .= HelpBox("보관장소 우선순위", $help_text, 171);
...
if($mmode == "pop"){
	...
	$P->Navigation = "재고관리 > 보관장소 우선순위";	
	$P->NaviTitle = "보관장소 우선순위";
