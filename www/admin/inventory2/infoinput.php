...
$Contents .="
				<tr height=55>
					<!--td class='list_box_td list_bg_gray'>
						<input type=checkbox class=nonborder id='cpid' name=cpid[] value='".$db->dt[id]."'><!--input type=hidden class=nonborder id='cpid' name=cpid[] value='".$db->dt[id]."'-->
					</td-->
		...
		$Contents .="
					...
					<td height='55' align=center>".$db->dt[option_name]."</td>
					<td height='55' nowrap>
...
$Contents .="
				<tr height=50><td colspan=9 align=center>발주상품 내역이  존재 하지 않습니다.</td></tr>
				";
			...
			<td colspan='2' style='padding:5px 0px;'>
				<table cellpadding=0 cellspacing=0 border=0 width=100% align=center class='input_table_box'>
						...
						<tr height='25'>
							...
							<td class='list_box_td' style='text-align:left; padding:10px;'><span>".number_format($order_totalprice)."원</span></td>
						...
						<tr height='25'>
							...
							<td class='list_box_td' style='text-align:left; padding:10px;'><span>".number_format($order_totalprice+$total_delivery_price)."원 (무료배송!, 배송비".number_format($total_delivery_price)."원 할인)</span></td>
							<td class='list_box_td list_bg_gray' style='text-align:left; padding:10px;'></td>
							<td class='list_box_td' style='text-align:left; padding:10px;'></td>
						</tr>
						<tr height='25'>
							...
							<td class='list_box_td' style='text-align:left; padding:3px 10px;'>
								<table cellpadding=0 cellspacing=0 border=0 bgcolor=#ffffff width=100%>
									...
									<tr>
										<TD nowrap>
										<input type='text' name='limit_priod' class='textbox' value='".$priod."' style='height:20px;width:70px;text-align:center;' id='priod'>
...
function num_apply(cart_key, pid) {
	...
	//document.write('countadd.php?cart_key='+cart_key+'&PID='+pid+'&act=mod&count='+quantity+'&sellprice='+sellprice+'&mode=$mode&est_ix=$est_ix');
	window.frames['act'].location.href='countadd.php?cart_key='+cart_key+'&PID='+pid+'&act=mod&count='+quantity+'&sellprice='+sellprice+'&mode=$mode&est_ix=$est_ix';
}
