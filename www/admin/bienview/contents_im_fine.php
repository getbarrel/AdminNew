					...
					<tr height=27>
						...
						<td class='search_box_item' >
							<select name='info_type' id='info_type'  style=\"font-size:12px;\">
                                <option value='' ".CompareReturnValue("",$info_type).">전체</option>
                                <option value='NEWS' ".CompareReturnValue("NEWS",$info_type).">NEWS</option>
                                <option value='FEATURES' ".CompareReturnValue("FEATURES",$info_type).">FEATURES</option>
                                <option value='DIARY' ".CompareReturnValue("DIARY",$info_type).">DIARY</option>
                            </select>
						</td>
					</tr>
					<tr height=27>
...
if(is_array($contents_array) && $total > 0){
    ...
    foreach($contents_array as $key => $val) {
        ...
        switch($val['div_depth_sub']){
            case 'news':
                $div_info_text = "NEWS";
                break;
            case 'features':
                $div_info_text = "FEATURES";
                break;
            case 'diary':
                $div_info_text = "DIARY";
                break;
	...
	<tr height=28 align=center>        
        ...
        <td class='list_box_td list_bg_gray'>".$div_info_text."</td>
        ...
        <td class='list_box_td list_bg_gray'> 
            <input type='button' value='수정' onclick=\"BienViewInput('im_fine','$val[co_ix]');\"/>
            <input type='button' value='삭제' onclick=\"BienViewDelete('im_fine','$val[co_ix]');\"/>
        </td>
    </tr>";
        $i++;
    }
...
$Contents01 .= "
    <tr height=28 align=center>        
        <td class='list_box_td' colspan='8'>
            <span>등록된 I'm Fine  목록이 없습니다.</span>            
        </td>
    </tr> ";
}
$Contents01 .= "   
    ...
    <table width='100%' border='0' cellpadding='3' cellspacing='0' align='center' >
        <tr height=40>
         <td colspan='9' align='right'><input type='button' onclick=\"BienViewInput('im_fine','');\" value='신규등록'></td>
        </tr>
    </table>
	";
$Contents01 .= "
...
$P->Navigation = "BIENVIEW관리 > 콘텐츠 관리 > I`m Fine 목록 ";
$P->title = "I`m Fine 목록";
