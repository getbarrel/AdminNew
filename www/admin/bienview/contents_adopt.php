...
if(is_array($contents_array) && $total > 0){
	...
	<tr height=28 align=center>        
        ...
        <td class='list_box_td list_bg_gray'>             
            <input type='button' value='수정' onclick=\"BienViewInput('adopt', '$val[co_ix]');\"/>
            <input type='button' value='삭제' onclick=\"BienViewDelete('adopt', '$val[co_ix]');\"/>
        </td>
    </tr>";
        $i++;
    }
...
$Contents01 .= "  
    ...
    <table width='100%' border='0' cellpadding='3' cellspacing='0' align='center' >
        <tr height=40>
         <td colspan='9' align='right'><input type='button' onclick=\"BienViewInput('adopt','');\" value='신규등록'></td>
        </tr>
    </table>
	";
$Contents01 .= "
...
$P->Navigation = "BIENVIEW관리 > 콘텐츠 관리 > 반려동물 입양 목록 ";
$P->title = "반려동물 입양 목록";
