		...
		<td align='left' colspan=2  width='100%' valign=top style='padding-top:0px;'>
			...
			<tr>
				<td class='box_05' valign=top style='padding:0px;'>
					...
					<tr height='27'>
						<td class='search_box_title' bgcolor='#efefef' align=center>
							<label for='search_check'><b>진행기간</b></label>
						</td>
						<td class='search_box_item'>
...
$Contents01 .= "
	...
	<tr bgcolor=#efefef style='font-weight:bold' align=center height=28>		
		...
		<td class='m_td'>진행기간</td>	
		<td class='m_td'>참여자수</td>	
		<td class='e_td'>관리</td>
	</tr>";
if(is_array($contents_array) && $total > 0){
	...
	<tr height=28 align=center>        
        ...
        <td class='list_box_td' > 
            <input type='button' value='수정' onclick=\"BienViewInput('and_you', '$val[co_ix]');\"/>
            <input type='button' value='삭제' onclick=\"BienViewDelete('and_you', '$val[co_ix]');\"/>
        </td>
    </tr>";
        $i++;
    }
...
$Contents01 .= "
    <tr height=28 align=center>        
        <td class='list_box_td' colspan='9'>
            <span>등록된 And You  목록이 없습니다.</span>            
        </td>
    </tr> ";
}
$Contents01 .= "   
    ...
    <table width='100%' border='0' cellpadding='3' cellspacing='0' align='center' >
        <tr height=40>
         <td colspan='9' align='right'><input type='button' onclick=\"BienViewInput('and_you','');\" value='신규등록'></td>
        </tr>
    </table>
	";
$Contents01 .= "
...
$P->Navigation = "BIENVIEW관리 > 콘텐츠 관리 > And You 목록 ";
$P->title = "And You 목록";
