...
if(is_array($contents_array) && $total > 0){
	...
	<tr height=28 align=center>        
        ...
        <td class='list_box_td' > 
            <input type='button' value='수정' onclick=\"BienViewInput('howau', '$val[co_ix]');\"/>
            <input type='button' value='삭제' onclick=\"BienViewDelete('howau', '$val[co_ix]');\"/>
        </td>
    </tr>";
        $i++;
    }
...
$Contents01 .= "
    <tr height=28 align=center>        
        <td class='list_box_td' colspan='7'>
            <span>등록된 How Are You 목록이 없습니다.</span>            
        </td>
    </tr> ";
}
$Contents01 .= "  
    ...
    <table width='100%' border='0' cellpadding='3' cellspacing='0' align='center' >
        <tr height=40>
         <td colspan='9' align='right'><input type='button' onclick=\"BienViewInput('howau','');\" value='신규등록'></td>
        </tr>
    </table>
	";
$Contents01 .= "
...
$P->Navigation = "BIENVIEW관리 > 콘텐츠 관리 > How Are You 목록 ";
$P->title = "How Are You 목록";
