					...
					<tr height=27>
						...
						<td class='search_box_item' >
							<select name='info_type' id='info_type'  style=\"font-size:12px;\">
                                ...
                                <option value='group' ".CompareReturnValue("group",$info_type).">단체</option>
                                <option value='shelter' ".CompareReturnValue("shelter",$info_type).">보호소</option>
                                <option value='volunteer' ".CompareReturnValue("volunteer",$info_type).">봉사활동</option>
                            </select>
						</td>
					</tr>
					<tr height=27>
...
$where = "where div_depth = 'protection' ";
if($_GET['mode'] == 'search'){
    if($_GET['info_type']){
...
if(is_array($contents_array) && $total > 0){
	...
	<tr height=28 align=center>        
        ...
        <td class='list_box_td list_bg_gray'> 
            <input type='button' value='수정' onclick=\"BienViewInput('protection','$val[co_ix]');\"/>
            <input type='button' value='삭제' onclick=\"BienViewDelete('protection','$val[co_ix]');\"/>
        </td>
    </tr>";
        $i++;
    }
...
$Contents01 .= "
    <tr height=28 align=center>        
        <td class='list_box_td' colspan='9'>
            <span>등록된 반려동물 입양 목록이 없습니다.</span>            
        </td>
    </tr> ";
}
$Contents01 .= "        
    ...
    <table width='100%' border='0' cellpadding='3' cellspacing='0' align='center' >
        <tr height=40>
         <td colspan='9' align='right'><input type='button' onclick=\"BienViewInput('protection','');\" value='신규등록'></td>
        </tr>
    </table>
	";
$Contents01 .= "
...
$P->Navigation = "BIENVIEW관리 > 콘텐츠 관리 > 동물보호활동 목록 ";
$P->title = "동물보호활동 목록";
