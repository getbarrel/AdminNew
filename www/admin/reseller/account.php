...
<table width='100%' border='0' align='center'>
  <tr>
    <td align='left' colspan=6 > ".GetTitleNavigation("리셀러 정산관리", "리셀러관리 >  회원관리 > 리셀러 정산관리")."</td>
  </tr>
  ...
  <tr>
	    ...
	    <div class='tab'>
			...
			<tr>
				<td class='tab'>
					<table id='tab_01' ".(!$status ? "class='on'" : "").">
					<tr>
						<th class='box_01'></th>
						<td class='box_02'><a href='".$_SERVER['PHP_SELF']."'>전체</a></td>
						<th class='box_03'></th>
					</tr>
					</table>
					<table id='tab_01' ".($status == "AR" ? "class='on'" : "").">
					<tr>
						<th class='box_01'></th>
						<td class='box_02'  ><a href='".$_SERVER['PHP_SELF']."?status=AR'>신청</a></td>
						<th class='box_03'></th>
					</tr>
					</table>
					<table id='tab_01' ".($status == "AC" ? "class='on'" : "").">
					<tr>
						<th class='box_01'></th>
						<td class='box_02'  ><a href='".$_SERVER['PHP_SELF']."?status=AC'>완료</a></td>
						<th class='box_03'></th>
					</tr>
					</table>
				</td>
...
<table width='100%' border='0' cellpadding='0' cellspacing='0'class='list_table_box'>
	<tr height='28' bgcolor='#ffffff'  align='center' >
		...
		<td width='8%' class='m_td'><font color='#000000'><b>구분</b></font></td>
		<td width='8%' class='m_td'><font color='#000000'><b>이름</b></font></td>
		<td width='8%' class=m_td><font color='#000000'><b>ID</b></font></td>
		<td width='8%' class=m_td><font color='#000000' ><b>Manager</b></font></td>
		<td width='14%' class=m_td><font color='#000000'><b>정산기준일</b></font></td>
		<td width='8%' class=m_td><font color='#000000'><b>정산유형</b></font></td>
		<td width='10%' class=m_td><font color='#000000'><b>정산금액</b></font></td>
		<td width='*' class=m_td><font color='#000000'><b>계좌정보</b></font></td>
		<td width='8%' class=m_td><font color='#000000'><b>상태</b></font></td>
		<td width='8%' class=m_td><font color='#000000'><b>관리</b></font></td>
	</tr>";

	include "account_query.php";

	//[S] 페이징
	$str_page_bar = page_bar($total, $page,$max, "&search_type=".$search_type."&search_text=".$search_text."&FromYY=".$FromYY."&FromMM=".$FromMM."&FromDD=".$FromDD."&ToYY=".$ToYY."&ToMM=".$ToMM."&ToDD=".$ToDD."&rsl_div=".$rsl_div."&status=".$status,"view");
	//[E] 페이징
	...
	if($total > 0){
		...
		for($i=0; $i<$db->total; $i++){
			...
			if($db->dt[rsl_div] == "R"){
				...
				$managerCost = number_format($mdb->dt[incentive_rate])."%";
			...
			$Contents.= "
				...
				<tr height='28'>
					<td class='list_box_td'><input type=checkbox name=ac_ix[] id='code' value='".$db->dt[ac_ix]."'></td>
					...
					<td class='list_box_td' >".$db->dt[ac_day]."</td>
					<td class='list_box_td' >".$way."</td>
					<td class='list_box_td' >".number_format($db->dt[sum_incentive])."원</td>
					...
					<td class='list_box_td ctr point' onMouseOver=\"this.style.backgroundColor='#E8ECF1';\" onMouseOut=\"this.style.backgroundColor=''\"  ><a href=\"javascript:PoPWindow('account.detail.php?ac_ix=".$db->dt[ac_ix]."',900,900,'reserve_pop')\"><img src='../images/".$admininfo["language"]."/bts_details.gif' border=0 align=absmiddle style='cursor:pointer;' alt='상세내역' title='상세내역'/></a></td>
				</tr>
		...
		$Contents = $Contents."
		  <tr height=50>
			<td colspan='12' align='center'>정산 데이타가 없습니다.</td>
		  </tr>";
	}
			...
			<tr height='60'>
				...
				<td class='top p10 lh160'>
					<div style='padding:12px 0 4px;'>
						<img src='../images/dot_org.gif'> <b>수수료 변경</b> <span class='small' style='color:gray'>체크박스 체크후 저장 버튼을 누르시면 정산이 완료됩니다.</span>
					</div>
						...
						<table cellpadding='3' cellspacing='0' width='100%' class='input_table_box'>
							...
							<tbody>
								<tr id='ht_level0_reason' class='ht_level0_reason_EY ht_level0_reason_EF ht_level0_reason_EM' style='display: table-row;'>
									<td class='input_box_title'> <b>정산상태</b></td>
									<td class='input_box_item'>
										<label><input type='radio' name='status' value='AC' checked='checked'/>정산완료</label>
									</td>
								</tr>
							</tbody>
						</table>
...
$Contents .= HelpBox("리셀러 정산관리", $help_text,'70');
...
$P->Navigation = "리셀러관리 > 정산관리 > 리셀러 정산관리";
$P->title = "리셀러 정산관리";
