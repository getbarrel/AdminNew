...
$db = new Database;
$db->query("SELECT * FROM reseller_dropmember  where rsl_code = '$rsl_code'");
$db->fetch();
...
$Contents = "
	<table border='0' width='100%' cellpadding='0' cellspacing='1' align='center'>
		<tr height=40>
			<td align='left' colspan=2> ".GetTitleNavigation("탈퇴회원 사유보기", "리셀러관리 > 리셀러탈퇴회원관리 > 탈퇴회원 사유보기", false)."</td>
		</tr>
		<tr>
...
$P->addScript = $Script;
$P->Navigation = "리셀러관리 > 리셀러탈퇴회원관리 > 탈퇴회원 사유보기";
